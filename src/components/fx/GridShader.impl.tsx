...
export function GridImpl({ pixelRatio }: { pixelRatio?: number }) {
  ...
  useEffect(() => {
    ...
    // runManagedRaf schedules each frame and pauses when off-screen or the tab
    // is hidden, so `frame` must NOT re-schedule itself.
