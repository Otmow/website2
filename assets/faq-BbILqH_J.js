import { r as s, j as r, d as L } from "./vendor-react-DLnSei1N.js";
import { c as U, N as je, R as j, M as we, P as Re, F as Ee } from "./FooterBlue-C091Jo7C.js";
import { D as Ie } from "./DottedSurfaceBlue-svXo1NfD.js";
import { L as Y } from "./LiteYouTube-BZ_NNowO.js";
import { c as Se, M as Pe } from "./index-CqBNPuiB.js";
const _e = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]],
  Me = Se("chevron-down", _e);
function V(e, o = []) {
  let t = [];
  function a(i, c) {
    ...
    t = [...t, c];
    const u = (m) => {
      const { scope: v, children: x, ...b } = m,
        g = v?.[e]?.[d] || l,
        h = s.useMemo(() => b, Object.values(b));
      return r.jsx(g.Provider, { value: h, children: x });
    };
  ...
  return ((n.scopeName = e), [a, Te(n, ...o)]);
}
function Te(...e) {
  const o = e[0];
  if (e.length === 1) return o;
  const t = () => {
    const a = e.map((n) => ({ useScope: n(), scopeName: n.scopeName }));
    return function (i) {
      const c = a.reduce((l, { useScope: d, scopeName: u }) => {
        const m = d(i)[`__scope${u}`];
        return { ...l, ...m };
      }, {});
      return s.useMemo(() => ({ [`__scope${o.scopeName}`]: c }), [c]);
    };
  };
...
function k(e) {
  const o = s.forwardRef((t, a) => {
    let { children: n, ...i } = t,
      c = null,
      l = !1;
    const d = [];
    (J(n) && typeof P == "function" && (n = P(n._payload)),
      s.Children.forEach(n, (v) => {
        if (Fe(v)) {
          l = !0;
          const x = v;
          let b = "child" in x.props ? x.props.child : x.props.children;
          (J(b) && typeof P == "function" && (b = P(b._payload)),
            (c = De(x, b)),
            d.push(c?.props?.children));
        } else d.push(v);
      }),
      c
        ? (c = s.cloneElement(c, void 0, d))
        : !l && s.Children.count(n) === 1 && s.isValidElement(n) && (c = n));
    const u = c ? ke(c) : void 0,
      p = E(a, u);
    if (!c) {
      if (n || n === 0) throw new Error(l ? ze(e) : Ve(e));
      return n;
    }
    const m = $e(i, c.props ?? {});
    return (c.type !== s.Fragment && (m.ref = a ? p : u), s.cloneElement(c, m));
  });
  return ((o.displayName = `${e}.Slot`), o);
}
var qe = Symbol.for("radix.slottable"),
  De = (e, o) => {
    if ("child" in e.props) {
    ...
    return s.isValidElement(o) ? o : null;
  };
function $e(e, o) {
  const t = { ...o };
  for (const a in o) {
    ...
    /^on[A-Z]/.test(a)
      ...
      : a === "style"
        ? (t[a] = { ...n, ...i })
        : a === "className" && (t[a] = [n, i].filter(Boolean).join(" "));
  }
  return { ...e, ...t };
}
function ke(e) {
...
function Be(e) {
  const o = e + "CollectionProvider",
    ...
    c = (g) => {
      const { scope: h, children: N } = g,
        f = s.useRef(null),
        C = s.useRef(new Map()).current;
      return r.jsx(n, { scope: h, itemMap: C, collectionRef: f, children: N });
    };
  c.displayName = o;
  const l = e + "CollectionSlot",
    d = k(l),
    u = s.forwardRef((g, h) => {
      const { scope: N, children: f } = g,
        C = i(l, N),
        y = E(h, C.collectionRef);
      return r.jsx(d, { ref: y, children: f });
    });
  u.displayName = l;
  const p = e + "CollectionItemSlot",
    ...
    x = s.forwardRef((g, h) => {
      ...
      return (
        s.useEffect(
          () => (
            w.itemMap.set(y, { ref: y, ...C }),
            () => {
              w.itemMap.delete(y);
            }
          ),
        ),
        r.jsx(v, { [m]: "", ref: R, children: f })
      );
    });
  x.displayName = p;
  function b(g) {
    ...
    return s.useCallback(() => {
      ...
      if (!f) return [];
      const C = Array.from(f.querySelectorAll(`[${m}]`));
      return Array.from(h.itemMap.values()).sort(
        (w, D) => C.indexOf(w.ref.current) - C.indexOf(D.ref.current),
      );
    }, [h.collectionRef, h.itemMap]);
  }
  return [{ Provider: c, Slot: u, ItemSlot: x }, b, a];
}
function ee(e, o, { checkForDefaultPrevented: t = !0 } = {}) {
  return function (n) {
    if ((e?.(n), t === !1 || !n.defaultPrevented)) return o?.(n);
  };
}
var I = globalThis?.document ? s.useLayoutEffect : () => {},
  We = L[" useInsertionEffect ".trim().toString()] || I;
function z({ prop: e, defaultProp: o, onChange: t = () => {}, caller: a }) {
  const [n, i, c] = He({ defaultProp: o, onChange: t }),
    l = e !== void 0,
    d = l ? e : n;
  {
    ...
    s.useEffect(() => {
      ...
      (m !== l &&
        console.warn(
          `${a} is changing from ${m ? "controlled" : "uncontrolled"} to ${l ? "controlled" : "uncontrolled"}. Components should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled value for the lifetime of the component.`,
        ),
        (p.current = l));
    }, [l, a]);
  }
...
function He({ defaultProp: e, onChange: o }) {
...
function Ge(e, o) {
  return s.useReducer((t, a) => o[t][a] ?? t, e);
}
var oe = (e) => {
  const { present: o, children: t } = e,
    a = Ye(o),
    n = typeof t == "function" ? t({ present: a.isPresent }) : s.Children.only(t),
    i = Ze(a.ref, Je(n));
  return typeof t == "function" || a.isPresent ? s.cloneElement(n, { ref: i }) : null;
};
  ...
  return (
    ...
    I(() => {
      ...
      if (p !== e) {
        ...
        (e
          ? d("MOUNT")
          : x === "none" || u?.display === "none"
            ? d("UNMOUNT")
            : d(p && v !== x ? "ANIMATION_OUT" : "UNMOUNT"),
          (n.current = e));
      }
    }, [e, d]),
    I(() => {
      if (o) {
        let u;
        const p = o.ownerDocument.defaultView ?? window,
          m = (x) => {
            const g = _(a.current).includes(CSS.escape(x.animationName));
            if (x.target === o && g && (d("ANIMATION_END"), !n.current)) {
              const h = o.style.animationFillMode;
              ((o.style.animationFillMode = "forwards"),
                (u = p.setTimeout(() => {
                  o.style.animationFillMode === "forwards" && (o.style.animationFillMode = h);
                })));
            }
          },
          v = (x) => {
            x.target === o && (i.current = _(a.current));
          };
        return (
    ...
    }, [o, d]),
    {
      ...
      ref: s.useCallback((u) => {
        ((a.current = u ? getComputedStyle(u) : null), t(u));
      }, []),
    }
  );
}
      ...
      if (n)
        return () => {
          for (let c = 0; c < i.length; c++) {
            const l = i[c];
            typeof l == "function" ? l() : X(a[c], null);
          }
        };
    }, [])
  );
...
var Xe = L[" useId ".trim().toString()] || (() => {}),
  eo = 0;
function te(e) {
  const [o, t] = s.useState(Xe());
  return (
    I(() => {
      t((a) => a ?? String(eo++));
    }, [e]),
...
var T = "Collapsible",
  ...
  re = s.forwardRef((e, o) => {
    const {
      ...
      [d, u] = z({ prop: a, defaultProp: n ?? !1, onChange: c, caller: T });
    return r.jsx(to, {
      scope: t,
      disabled: i,
      contentId: te(),
      open: d,
      onOpenToggle: s.useCallback(() => u((p) => !p), [u]),
...
re.displayName = T;
var ae = "CollapsibleTrigger",
  se = s.forwardRef((e, o) => {
    const { __scopeCollapsible: t, ...a } = e,
      n = B(ae, t);
    return r.jsx(S.button, {
      type: "button",
...
var W = "CollapsibleContent",
  ie = s.forwardRef((e, o) => {
    const { forceMount: t, ...a } = e,
      n = B(W, e.__scopeCollapsible);
    return r.jsx(oe, {
      present: t || n.open,
      children: ({ present: i }) => r.jsx(no, { ...a, ref: o, present: i }),
    });
  });
ie.displayName = W;
var no = s.forwardRef((e, o) => {
  const { __scopeCollapsible: t, present: a, children: n, ...i } = e,
    c = B(W, t),
    [l, d] = s.useState(a),
    u = s.useRef(null),
    p = E(o, u),
    ...
    I(() => {
      ...
      if (f) {
        ...
        ((m.current = C.height),
          (x.current = C.width),
          h.current ||
            ((f.style.transitionDuration = N.current.transitionDuration),
            (f.style.animationName = N.current.animationName)),
          d(a));
      }
    }, [c.open, a]),
    r.jsx(S.div, {
...
var ro = re,
  ao = se,
  so = ie,
  io = s.createContext(void 0);
function co(e) {
  const o = s.useContext(io);
  return e || o || "ltr";
}
var A = "Accordion",
  lo = ["Home", "End", "ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight"],
  [Q, uo, mo] = Be(A),
  [O] = V(A, [mo, ne]),
  K = ne(),
  ce = s.forwardRef((e, o) => {
    const { type: t, ...a } = e,
      n = a,
      i = a;
    return r.jsx(Q.Provider, {
      scope: e.__scopeAccordion,
      children: t === "multiple" ? r.jsx(vo, { ...i, ref: o }) : r.jsx(xo, { ...n, ref: o }),
    });
  });
ce.displayName = A;
var [le, po] = O(A),
  [de, fo] = O(A, { collapsible: !1 }),
  xo = s.forwardRef((e, o) => {
    const { value: t, defaultValue: a, onValueChange: n = () => {}, collapsible: i = !1, ...c } = e,
      [l, d] = z({ prop: t, defaultProp: a ?? "", onChange: n, caller: A });
    return r.jsx(le, {
      scope: e.__scopeAccordion,
      value: s.useMemo(() => (l ? [l] : []), [l]),
      onItemOpen: d,
      onItemClose: s.useCallback(() => i && d(""), [i, d]),
      children: r.jsx(de, {
        scope: e.__scopeAccordion,
        collapsible: i,
        children: r.jsx(ue, { ...c, ref: o }),
      }),
    });
  }),
  vo = s.forwardRef((e, o) => {
    const { value: t, defaultValue: a, onValueChange: n = () => {}, ...i } = e,
      [c, l] = z({ prop: t, defaultProp: a ?? [], onChange: n, caller: A }),
      d = s.useCallback((p) => l((m = []) => [...m, p]), [l]),
      u = s.useCallback((p) => l((m = []) => m.filter((v) => v !== p)), [l]);
    return r.jsx(le, {
      scope: e.__scopeAccordion,
      value: c,
      onItemOpen: d,
      ...
      children: r.jsx(de, {
        scope: e.__scopeAccordion,
        collapsible: !0,
        children: r.jsx(ue, { ...i, ref: o }),
      }),
    });
  }),
  [ho, q] = O(A),
  ue = s.forwardRef((e, o) => {
    const { __scopeAccordion: t, disabled: a, dir: n, orientation: i = "vertical", ...c } = e,
      l = s.useRef(null),
      d = E(l, o),
      u = uo(t),
      m = co(n) === "ltr",
      v = ee(e.onKeyDown, (x) => {
        if (!lo.includes(x.key)) return;
        const b = x.target,
          g = u().filter(($) => !$.ref.current?.disabled),
          h = g.findIndex(($) => $.ref.current === b),
          N = g.length;
        if (h === -1) return;
        x.preventDefault();
        let f = h;
    ...
    return r.jsx(ho, {
      ...
      direction: n,
      orientation: i,
      children: r.jsx(Q.Slot, {
        scope: t,
        children: r.jsx(S.div, { ...c, "data-orientation": i, ref: d, onKeyDown: a ? void 0 : v }),
      }),
    });
  }),
  M = "AccordionItem",
  [bo, G] = O(M),
  me = s.forwardRef((e, o) => {
    const { __scopeAccordion: t, value: a, ...n } = e,
      i = q(M, t),
      c = po(M, t),
      l = K(t),
      d = te(),
      u = (a && c.value.includes(a)) || !1,
...
me.displayName = M;
var pe = "AccordionHeader",
  fe = s.forwardRef((e, o) => {
    const { __scopeAccordion: t, ...a } = e,
      n = q(A, t),
      i = G(pe, t);
    return r.jsx(S.h3, {
...
var go = ce,
  ...
  Ce = he;
const yo = go,
  Ne = s.forwardRef(({ className: e, ...o }, t) =>
    r.jsx(Co, { ref: t, className: U("border-b", e), ...o }),
  );
Ne.displayName = "AccordionItem";
const ye = s.forwardRef(({ className: e, children: o, ...t }, a) =>
  r.jsx(No, {
    className: "flex",
    children: r.jsxs(ge, {
      ref: a,
...
ye.displayName = ge.displayName;
const Ae = s.forwardRef(({ className: e, children: o, ...t }, a) =>
  r.jsx(Ce, {
    ref: a,
    className:
      "overflow-hidden text-sm data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down",
    ...t,
    children: r.jsx("div", { className: U("pb-4 pt-0", e), children: o }),
  }),
);
...
function So() {
  return r.jsxs("div", {
    ...
    children: [
      r.jsx(je, {}),
      r.jsxs("section", {
        className: "relative overflow-hidden pb-16 pt-40 md:pt-48",
        children: [
          r.jsx(Ie, { className: "opacity-50" }),
          r.jsx("div", {
            ...
            children: [
              ...
              r.jsx(j, {
                ...
                children: r.jsx("p", {
                  ...
                  children:
                    "Respostas simples e diretas para as questões mais comuns. Nosso objetivo é tornar sua experiência mais prática, transparente e sem complicações.",
                }),
              }),
            ],
          }),
              ...
              children: Ao.map((e, o) =>
                r.jsxs(
                  Ne,
                  {
                    value: `item-${o}`,
                    className:
                      "rounded-xl border border-white/10 bg-white/[0.03] px-6 transition-colors data-[state=open]:border-[#3674EF]/45",
                    children: [
                      r.jsx(ye, {
                        className:
                          "py-5 text-left text-sm font-semibold text-white hover:no-underline md:text-base",
                        children: e.q,
                      }),
                      r.jsx(Ae, {
                        className: "pb-5 text-sm leading-relaxed text-slate-400",
                        children: e.a,
                      }),
                    ],
                  },
      ...
      r.jsx("section", {
        className: "border-t border-white/10 py-24 md:py-28",
        children: r.jsxs("div", {
            ...
            r.jsx(j, {
              children: r.jsxs("div", {
                ...
                children: [
                  ...
                  r.jsx("h2", {
                    className: "mt-4 font-display text-balance text-3xl font-bold md:text-4xl",
                ...
                r.jsx(j, {
                  children: r.jsxs("div", {
                    children: [
                      ...
                      r.jsx(Y, { id: "fE-LkwIrT-s", title: "Podcast explicativo — Ótmow" }),
                    ],
                  }),
                }),
                r.jsx(j, {
                  ...
                  children: r.jsxs("div", {
                    children: [
                      ...
                      r.jsx(Y, { id: "DSg6TKhjNxI", title: "Sobre a Ótmow" }),
                    ],
                  }),
                }),
              ],
      ...
      r.jsx("section", {
        className: "border-t border-white/10 bg-[#081127] py-24",
        children: r.jsxs("div", {
          className: "mx-auto max-w-7xl px-5 md:px-8",
          children: [
            r.jsx(j, {
                ...
                r.jsx(
                  j,
                  {
                    ...
                    children: r.jsxs("a", {
                      ...
                      rel: "noreferrer",
                      className:
                        "block h-full rounded-2xl border border-white/10 bg-white/[0.03] p-7 text-center transition-all hover:border-[#3674EF]/45 hover:bg-white/[0.06]",
                      children: [
                        r.jsx("div", {
                          className:
                            "mx-auto flex size-14 items-center justify-center rounded-2xl bg-[#3674EF]/15",
                          children: r.jsx(e.icon, { className: "size-7 text-[#4EB7FF]" }),
                        }),
                        r.jsx("h3", {
                        ...
                        r.jsx("p", {
                          className: "mt-3 text-sm font-semibold text-[#4EB7FF]",
                          children: e.v,
                        }),
                      ],
                    }),
