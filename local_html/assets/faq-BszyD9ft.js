...
import {
  ...
  P as Ee,
  F as Ie,
} from "./FooterBlue-DXismSK9.js";
import { D as Se } from "./DottedSurfaceBlue-B-OwPgey.js";
import { L as Y } from "./LiteYouTube-Dhb8mDLJ.js";
import "./index-pNzFXLul.js";
const Pe = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]],
  _e = ee("chevron-down", Pe);
const Me = [
    [
      "path",
      {
...
function k(e) {
  const o = s.forwardRef((t, a) => {
    ...
    const u = c ? Fe(c) : void 0,
      p = E(a, u);
    if (!c) {
      if (n || n === 0) throw new Error(l ? Be(e) : ze(e));
      return n;
    }
    const m = ke(i, c.props ?? {});
...
function Qe({ defaultProp: e, onChange: o }) {
...
var eo = L[" useId ".trim().toString()] || (() => {}),
  oo = 0;
function ne(e) {
  const [o, t] = s.useState(eo());
  return (
    I(() => {
      t((a) => a ?? String(oo++));
    }, [e]),
...
var se = "CollapsibleTrigger",
  ie = s.forwardRef((e, o) => {
    ...
    return r.jsx(S.button, {
      ...
      ...a,
      ref: o,
      onClick: oe(e.onClick, n.onOpenToggle),
    });
  });
ie.displayName = se;
var W = "CollapsibleContent",
  ce = s.forwardRef((e, o) => {
    ...
    return r.jsx(te, {
      present: t || n.open,
      children: ({ present: i }) => r.jsx(ro, { ...a, ref: o, present: i }),
    });
  });
ce.displayName = W;
var ro = s.forwardRef((e, o) => {
...
var ao = ae,
  so = ie,
  io = ce,
  co = s.createContext(void 0);
function lo(e) {
  const o = s.useContext(co);
  return e || o || "ltr";
}
var A = "Accordion",
  uo = ["Home", "End", "ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight"],
  [Q, mo, po] = We(A),
  [O] = V(A, [po, re]),
  K = re(),
  le = s.forwardRef((e, o) => {
    ...
    return r.jsx(Q.Provider, {
      ...
      children: t === "multiple" ? r.jsx(ho, { ...i, ref: o }) : r.jsx(vo, { ...n, ref: o }),
    });
  });
le.displayName = A;
var [de, fo] = O(A),
  [ue, xo] = O(A, { collapsible: !1 }),
  vo = s.forwardRef((e, o) => {
...
var Co = le,
  ...
  Ne = be;
const Ao = Co,
  ye = s.forwardRef(({ className: e, ...o }, t) =>
    r.jsx(No, { ref: t, className: U("border-b", e), ...o }),
  );
...
const je = s.forwardRef(({ className: e, children: o, ...t }, a) =>
  r.jsx(Ne, {
    ref: a,
    className:
