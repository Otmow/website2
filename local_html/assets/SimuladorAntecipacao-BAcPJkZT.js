import { c as k } from "./index-CqBNPuiB.js";
import { r as s, j as e } from "./vendor-react-DLnSei1N.js";
import { R as h, A as f } from "./FooterBlue-C091Jo7C.js";
const A = [
    [
      "path",
      {
          ...
          children:
            c === 1
              ? e.jsx("form", {
                  onSubmit: S,
                  className:
                    "mx-auto mt-14 max-w-xl rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:p-10 text-left shadow-2xl",
                  children: e.jsxs("div", {
                    ...
                    children: [
                      e.jsxs("div", {
                        children: [
                          ...
                          e.jsx("input", {
                            ...
                            className:
                              "mt-2 w-full rounded-xl border border-white/10 bg-[#060d1f] px-4 py-3 text-sm text-white placeholder-slate-500 outline-none focus:border-[#4EB7FF] focus:ring-1 focus:ring-[#4EB7FF] transition-all",
                      ...
                      e.jsxs("div", {
                        children: [
                          e.jsx("label", {
                            ...
                            className: "block text-sm font-medium text-slate-300",
                            children: "Valor da Nota Fiscal (R$)",
                          }),
                          e.jsx("input", {
                            id: "invoiceAmount",
                            required: !0,
                      ...
                      e.jsxs("button", {
                        type: "submit",
                        className:
                          "mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-[#3674EF] px-8 py-4 text-sm font-semibold text-white transition-transform duration-300 hover:scale-[1.02]",
                        children: [
                          "Ver condições de antecipação",
                          e.jsx(f, { className: "size-4" }),
                        ],
                      }),
                    ],
                  }),
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx("button", {
                          ...
                          onClick: () => d(1),
                          className:
                            "absolute top-4 right-6 text-slate-400 hover:text-white transition-colors text-xs font-medium underline underline-offset-4",
                          children: "Voltar e editar dados",
                        }),
                        e.jsx("label", {
                          htmlFor: "sim-amount",
                        ...
                        e.jsx("input", {
                          ...
                          step: 5e3,
                          value: l,
                          onChange: (t) => x(Number(t.target.value)),
                          className: "mt-5 w-full accent-[#4EB7FF]",
                        }),
                        e.jsxs("div", {
                          className: "mt-2 flex justify-between text-xs text-slate-500",
                          children: [
                            e.jsx("span", { children: a.format(r) }),
                            e.jsx("span", { children: a.format(n) }),
                          ],
                        }),
                        e.jsx("p", {
