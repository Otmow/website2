const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/sobre-BHtEu2g1.js",
      "assets/vendor-react-DLnSei1N.js",
      "assets/FooterBlue-BnGcN94H.js",
      "assets/DottedSurfaceBlue-C_uHjpcU.js",
      "assets/GridShader-KAVeuOKc.js",
      "assets/CountUp-CnNs-zEX.js",
      "assets/trending-up-UK1V5xu8.js",
      "assets/parceiros-HxRDixFa.js",
      "assets/shield-check-B30b2BtR.js",
      "assets/lock-C5yIW-mr.js",
      "assets/gestores-C2xhTDPA.js",
      "assets/faq-CG-you58.js",
      "assets/LiteYouTube-OM9aODpE.js",
      "assets/clientes-DM5mec6C.js",
      "assets/SimuladorAntecipacao-Bxxz-qOy.js",
      "assets/index-B4Q7Ts38.js",
    ]),
) => i.map((i) => d[i]);
...
function jo(e, t, r, n, s) {
  ...
  return (
    i || ((i = xe("/")), kt(t, new Uint16Array(6), { from: e }, 1, i, 0), s.singleCache.set(o, i)),
    br(n, i, r)
  );
}
function Do(e, t, r = !1) {
    ...
    constructor(e, t) {
      ((this.tempLocationKey = `${Math.round(Math.random() * 1e7)}`),
        ...
        (this.buildRouteTree = () => {
          ...
          return (this.options.routeMasks && Fo(this.options.routeMasks, r.processedTree), r);
        }),
        (this.subscribe = (r, n) => {
            ...
            s = (o = {}, i) => {
              ...
              if (!a) {
                ...
                if (this.options.routeMasks) {
                  const f = ko(c.pathname, this.processedTree);
                  if (f) {
...
async function Tc(e, t, r, n) {
  let s = Rs(n, e.base.features);
  return Fa(r, n, s ? await _r(e, t, s) : d);
}
...
async function jc(e, t, r, n) {
  return Na(r, Ut(e.base, 4), await new Promise(kc.bind(e, t, r, n)));
}
...
async function Nc(e, t, r, n) {
  ...
  if (s === Promise || n instanceof Promise) return Fc(e, t, r, n);
...
function Zc(e, t, r) {
  ...
  for (let i = 0, c; i < s; i++) ((c = n[i]), c && (o[i] = F(e, t, c)));
  return (ks(o, r.o), o);
}
function eu(e) {
  switch (e) {
...
function ru(e, t, r, n, s) {
  if (typeof n == "string") vn(r, pe(n), F(e, t, s));
  else {
    let o = F(e, t, n);
    switch (typeof o) {
      case "string":
...
function nu(e, t, r) {
  ...
  return (Ns(e, t, r.p, n), ks(n, r.o), n);
}
function su(e, t) {
...
function iu(e, t, r) {
  ...
  for (let s = 0, o = r.a, i = o.length; s < i; s++) n.add(F(e, t, o[s]));
  return n;
}
function au(e, t, r) {
  let n = B(e, r.i, new Map());
  for (let s = 0, o = r.e.k, i = r.e.v, c = o.length; s < c; s++)
    n.set(F(e, t, o[s]), F(e, t, i[s]));
  return n;
}
function cu(e, t) {
...
function pu(e, t, r) {
  return B(e, r.i, Object(F(e, t, r.f)));
}
function mu(e, t, r) {
...
function yu(e, t, r) {
  ...
  if (n) return (ct(e, r, r.i, 22), n.s(F(e, t, r.a[1])), d);
  throw new at("Promise");
}
function vu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ct(e, r, r.i, 22), n.f(F(e, t, r.a[1])), d);
  throw new at("Promise");
}
function wu(e, t, r) {
  F(e, t, r.a[0]);
...
function Su(e, t, r) {
  ...
  let s = r.a,
    o = s.length;
  if (o) for (let i = 0; i < o; i++) F(e, t, s[i]);
  return n;
}
function xu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ct(e, r, r.i, 31), n.next(F(e, t, r.f)), d);
  throw new at("Stream");
}
function Pu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ct(e, r, r.i, 31), n.throw(F(e, t, r.f)), d);
  throw new at("Stream");
}
function Ru(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ct(e, r, r.i, 31), n.return(F(e, t, r.f)), d);
  throw new at("Stream");
}
function _u(e, t, r) {
  return (F(e, t, r.f), d);
...
function Cu(e, t, r) {
  return (F(e, t, r.a[1]), d);
}
function Eu(e, t, r) {
  let n = B(e, r.i, Ms([], r.s, r.l));
  for (let s = 0, o = r.a.length; s < o; s++) n.v[s] = F(e, t, r.a[s]);
  return n;
}
function F(e, t, r) {
...
async function Au(e, t, r) {
  ...
  return await Fu(async () => s(e, { method: n.method, headers: i, signal: n.signal, body: c }));
}
async function $s(e) {
  let t = !1;
  const r = {};
...
async function ku({ jsonStream: e, onMessage: t, onError: r }) {
  const n = e.getReader(),
...
function al(e, t) {
  const r = $(),
    ...
    z = I.useMemo(() => {
      const k = { _fromLocation: ge, ...qe };
      return r.buildLocation(k);
    }, [r, ge, qe]),
    Fr = z.maskedLocation ? z.maskedLocation.publicHref : z.publicHref,
    kr = z.maskedLocation ? z.maskedLocation.external : z.external,
    He = I.useMemo(() => hl(Fr, kr, r.history, w), [w, kr, Fr, r.history]),
    Ve = I.useMemo(() => {
    ...
    Ht = I.useMemo(() => {
      ...
      if (i?.exact) {
        ...
        const k = It(ge.pathname, r.basepath),
          W = It(z.pathname, r.basepath);
        if (!(k.startsWith(W) && (k.length === W.length || k[W.length] === "/"))) return !1;
      }
    ...
    ye = I.useCallback(() => {
      r.preloadRoute({ ...qe, _builtLocation: z }).catch((k) => {
        (console.warn(k), console.warn(Ci));
      });
    }, [r, qe, z]);
  (Uu(
    n,
  ...
  const ho = (k) => {
    const W = k.currentTarget.getAttribute("target"),
      ve = y !== void 0 ? y : W;
    if (!w && !ml(k) && !k.defaultPrevented && (!ve || ve === "_self") && k.button === 0) {
      (k.preventDefault(),
        go.flushSync(() => {
          Nr(!0);
        }));
...
function Fl({ router: e, children: t, ...r }) {
...
function kl({ router: e, ...t }) {
  return x.jsx(Fl, { router: e, ...t, children: x.jsx(Ll, {}) });
}
function Ln(e, t) {
  if (t)
...
var ke = (e, t) => {
  const r = { type: "request", ...(t || e) },
    n = (s) => ke({}, Object.assign(r, { validator: s, inputValidator: s }));
  return {
    options: r,
    middleware: (s) => ke({}, Object.assign(r, { middleware: s })),
    validator: n,
    inputValidator: n,
    client: (s) => ke({}, Object.assign(r, { client: s })),
    server: (s) => ke({}, Object.assign(r, { server: s })),
  };
};
function no(e, t) {
  for (let r = 0, n = t.length; r < n; r++) {
...
function uo(e) {
  ...
  const s = sf(),
    ...
    l = () => so.isFocused() && (e.networkMode === "always" || Ft.isOnline()) && e.canRun(),
...
const Sf = "/assets/styles-6bFxeo_y.css";
function xf(e, t = {}) {
  typeof window > "u" ||
...
const Ef = "modulepreload",
  ...
  Lf = () => $e(() => import("./sobre-BHtEu2g1.js"), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6])),
  Mf = Be("/sobre")({ component: Ue(Lf, "component") }),
  Tf = () => $e(() => import("./parceiros-HxRDixFa.js"), __vite__mapDeps([7, 1, 2, 3, 8, 9])),
  Af = Be("/parceiros")({ component: Ue(Tf, "component") }),
  Of = () => $e(() => import("./gestores-C2xhTDPA.js"), __vite__mapDeps([10, 1, 2, 4, 8])),
  Ff = Be("/gestores")({ component: Ue(Of, "component") }),
  kf = () => $e(() => import("./faq-CG-you58.js"), __vite__mapDeps([11, 1, 2, 3, 12])),
  jf = Be("/faq")({ component: Ue(kf, "component") }),
  Df = () =>
    $e(() => import("./clientes-DM5mec6C.js"), __vite__mapDeps([13, 1, 2, 14, 3, 5, 9, 8])),
  Nf = Be("/clientes")({ component: Ue(Df, "component") }),
  Bf = () =>
    $e(() => import("./index-B4Q7Ts38.js"), __vite__mapDeps([15, 1, 2, 14, 12, 3, 4, 5, 8, 6, 9])),
  ...
  qf = Ff.update({ id: "/gestores", path: "/gestores", getParentRoute: () => me }),
...
var or;
function Zf() {
  return (or || (or = Xf()), x.jsx(qu, { promise: or, children: (e) => x.jsx(kl, { router: e }) }));
}
I.startTransition(() => {
