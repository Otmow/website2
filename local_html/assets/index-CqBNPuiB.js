const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/sobre-7dI86hRK.js",
      "assets/vendor-react-DLnSei1N.js",
      "assets/FooterBlue-C091Jo7C.js",
      "assets/DottedSurfaceBlue-svXo1NfD.js",
      "assets/GridShader-CiYTFvVp.js",
      "assets/CountUp-CnNs-zEX.js",
      "assets/trending-up-Daa0ZRc7.js",
      "assets/parceiros-pC3_ubjC.js",
      "assets/shield-check-Brpfnbh_.js",
      "assets/lock-BS6n1Q2k.js",
      "assets/gestores-BWMomBnK.js",
      "assets/faq-BbILqH_J.js",
      "assets/LiteYouTube-BZ_NNowO.js",
      "assets/clientes-DmzIpULA.js",
      "assets/SimuladorAntecipacao-BAcPJkZT.js",
      "assets/index-D3XUc_xl.js",
    ]),
) => i.map((i) => d[i]);
import { r as C, j as w, R as Ze, a as zn, b as bo, c as wo } from "./vendor-react-DLnSei1N.js";
var xo = "__TSS_CONTEXT",
  ar = Symbol.for("TSS_SERVER_FUNCTION"),
  So = "application/x-tss-framed",
...
var $n = () => window.__TSS_START_OPTIONS__;
const qn = !1;
function et(e) {
  return e[e.length - 1];
}
...
function Vn(e) {
  for (const t in e) if (Hn.call(e, t)) return !0;
  return !1;
}
...
function Hr(e) {
  ...
  for (const s of t) if (!qr.call(e, s)) return !1;
  const r = Object.getOwnPropertySymbols(e);
  if (r.length === 0) return t;
  const n = t;
  for (const s of r) {
    if (!qr.call(e, s)) return !1;
    n.push(s);
  }
  return n;
}
function Et(e) {
  ...
  const r = t.prototype;
  return !(!Vr(r) || !r.hasOwnProperty("isPrototypeOf"));
}
function Vr(e) {
...
const Mo = ["http:", "https:", "mailto:", "tel:"];
function It(e, t) {
  if (!e) return !1;
  try {
    const r = new URL(e);
...
function Ke(e) {
  ...
  let r = 0,
    n = "",
    s;
  for (; (s = t.exec(e)) !== null; ) ((n += Kr(e.slice(r, s.index)) + s[0]), (r = t.lastIndex));
  n = n + Kr(r ? e.slice(r) : e);
  let o = !1;
  return (
...
function Kn(e, t, r = new Uint16Array(6)) {
  const n = e.indexOf("/", t),
    s = n === -1 ? e.length : n,
    o = e.substring(t, s);
  if (!o || !o.includes("$"))
...
function kt(e, t, r, n, s, o, i) {
  ...
  let c = n;
  {
    ...
    for (; c < l; ) {
      ...
      switch (((c = m + 1), o++, h[0])) {
        case 0: {
          const y = a.substring(h[2], h[3]);
          if (f) {
            const b = s.static?.get(y);
            if (b) g = b;
            else {
              s.static ??= new Map();
              const S = Se(r.fullPath ?? r.from);
              ((S.parent = s), (S.depth = o), (g = S), s.static.set(y, S));
            }
          } else {
            const b = y.toLowerCase(),
              S = s.staticInsensitive?.get(b);
            if (S) g = S;
            else {
              s.staticInsensitive ??= new Map();
              const x = Se(r.fullPath ?? r.from);
              ((x.parent = s), (x.depth = o), (g = x), s.staticInsensitive.set(b, x));
            }
          }
          break;
        }
        case 1: {
          const y = a.substring(v, h[1]),
            b = a.substring(h[4], m),
            S = f && !!(y || b),
            x = y ? (S ? y : y.toLowerCase()) : void 0,
            P = b ? (S ? b : b.toLowerCase()) : void 0,
            E =
              !u &&
              s.dynamic?.find(
                (R) => !R.parse && R.caseSensitive === S && R.prefix === x && R.suffix === P,
              );
          if (E) g = E;
          else {
            const R = Qt(1, r.fullPath ?? r.from, S, x, P);
            ((g = R), (R.depth = o), (R.parent = s), (s.dynamic ??= []), s.dynamic.push(R));
          }
          break;
        }
        case 3: {
          ...
          if (E) g = E;
            ...
            const R = Qt(3, r.fullPath ?? r.from, S, x, P);
            ((g = R), (R.parent = s), (R.depth = o), (s.optional ??= []), s.optional.push(R));
          }
          break;
        }
        case 2: {
          const y = a.substring(v, h[1]),
            ...
            x = y ? (S ? y : y.toLowerCase()) : void 0,
            P = b ? (S ? b : b.toLowerCase()) : void 0,
            E = Qt(2, r.fullPath ?? r.from, S, x, P);
          ((g = E), (E.parent = s), (E.depth = o), (s.wildcard ??= []), s.wildcard.push(E));
        }
      }
      s = g;
    }
    if (u && r.children && !r.isRoot && r.id && r.id.charCodeAt(r.id.lastIndexOf("/") + 1) === 95) {
      const h = Se(r.fullPath ?? r.from);
      ((h.kind = Wn),
        (h.parent = s),
        o++,
        (h.depth = o),
    ...
    if (p && a.endsWith("/")) {
      const h = Se(r.fullPath ?? r.from);
      ((h.kind = ue), (h.parent = s), o++, (h.depth = o), (s.index = h), (s = h));
    }
    ((s.parse = u ?? null),
      (s.priority = r.options?.params?.priority ?? 0),
      p && !s.route && ((s.route = r), (s.fullPath = r.fullPath ?? r.from)));
  }
  if (r.children) for (const a of r.children) kt(e, t, a, c, s, o, i);
}
function Kt(e, t) {
...
function No(e, t) {
  const r = Se("/"),
    n = new Uint16Array(6);
  for (const s of e) kt(!1, n, s, 1, r, 0);
  (ae(r), (t.masksTree = r), (t.flatCache = rt(1e3)));
}
function Do(e, t) {
  e ||= "/";
  const r = t.flatCache.get(e);
  if (r) return r;
  const n = xr(e, t.masksTree);
...
function Bo(e, t, r, n, s) {
  ...
  return (
    i || ((i = Se("/")), kt(t, new Uint16Array(6), { from: e }, 1, i, 0), s.singleCache.set(o, i)),
    xr(n, i, r)
  );
}
function Uo(e, t, r = !1) {
  ...
  let o;
  try {
    o = xr(e, t.segmentTree, r);
  } catch (i) {
    if (i instanceof URIError) o = null;
    else throw i;
  }
  return (o && (o.branch = Gn(o.route)), t.matchCache.set(n, o), o);
}
function zo(e) {
  return e === "/" ? e : e.replace(/\/{1,}$/, "");
}
function $o(e, t = !1, r) {
  const n = Se(e.fullPath),
    s = new Uint16Array(6),
    o = {},
    i = {};
  let c = 0;
...
function Qn(e, t, r) {
  ...
  for (; c < n.length; i++, c++, a++, l++) {
    ...
    if ((u && (a += u.length), f.kind === 1)) {
      ...
      const h = s[l],
        g = f.prefix?.length ?? 0;
      if (h.charCodeAt(g) === 123) {
        const v = f.suffix?.length ?? 0,
          m = h.substring(g + 2, h.length - v - 1),
      ...
      const h = s[l],
        g = f.prefix?.length ?? 0,
        v = f.suffix?.length ?? 0,
        m = h.substring(g + 3, h.length - v - 1),
        y = f.suffix || f.prefix ? u.substring(g, u.length - v) : u;
      y && (o[m] = decodeURIComponent(y));
    } else if (f.kind === 2) {
      const h = f,
        g = e.substring(p + (h.prefix?.length ?? 0), e.length - (h.suffix?.length ?? 0)),
...
function Ho(e, t, r, n) {
  ...
  for (; c.length; ) {
    const f = c.pop(),
      { node: u, index: p, skipped: h, depth: g, statics: v, dynamics: m, optionals: y } = f;
    let { extract: b, rawParams: S } = f;
    if (u.kind === 2 && u.route && !pt(l, f)) continue;
    if (u.parse) {
      if (!Qr(e, t, f)) continue;
      ((S = f.rawParams), (b = f.extract));
    }
    n && u.route && u.kind !== ue && pt(a, f) && (a = f);
    const x = p === i;
    if (
      x &&
      (u.route && (!o || u.kind === ue || u.kind === 2) && pt(l, f) && (l = f),
      !u.optional && !u.wildcard && !u.index && !u.pathless)
    )
      continue;
    const P = x ? void 0 : t[p];
    let E;
    if (x && u.index) {
      const R = {
        node: u.index,
      ...
      let _ = !0;
      if ((u.index.parse && (Qr(e, t, R) || (_ = !1)), _)) {
        if (!m && !y && !h && Vo(v, i)) return R;
        pt(l, R) && (l = R);
      }
    }
    if (u.wildcard)
      for (let R = u.wildcard.length - 1; R >= 0; R--) {
        const _ = u.wildcard[R],
          { prefix: I, suffix: M } = _;
        if (!(I && (x || !(_.caseSensitive ? P : (E ??= P.toLowerCase())).startsWith(I)))) {
          if (M) {
            if (x) continue;
            const L = t.slice(p).join("/").slice(-M.length);
    ...
    if (u.optional) {
      const R = h | (1 << g),
        _ = g + 1;
      for (let I = u.optional.length - 1; I >= 0; I--) {
        const M = u.optional[I];
        c.push({
          node: M,
          index: p,
          skipped: R,
      ...
      if (!x)
        for (let I = u.optional.length - 1; I >= 0; I--) {
          const M = u.optional[I],
            { prefix: L, suffix: A } = M;
          if (L || A) {
            const J = M.caseSensitive ? P : (E ??= P.toLowerCase());
    ...
    if (!x && u.dynamic && P)
      for (let R = u.dynamic.length - 1; R >= 0; R--) {
        const _ = u.dynamic[R],
          { prefix: I, suffix: M } = _;
        if (I || M) {
          const L = _.caseSensitive ? P : (E ??= P.toLowerCase());
          if ((I && !L.startsWith(I)) || (M && !L.endsWith(M))) continue;
        }
        c.push({
          node: _,
          index: p + 1,
    ...
    if (!x && u.staticInsensitive) {
      const R = u.staticInsensitive.get((E ??= P.toLowerCase()));
      R &&
        c.push({
          node: R,
          index: p + 1,
  ...
  if (n && a) {
    let f = a.index;
    for (let p = 0; p < a.index; p++) f += t[p].length;
...
function Wo(e, t, r) {
  return Lt(e, r) === Lt(t, r);
}
function Ko({ base: e, to: t, trailingSlash: r = "never", cache: n }) {
  ...
  if (o) c = e.split("/");
    ...
    for (c = e.split("/"); c.length > 1 && et(c) === ""; ) c.pop();
    const l = t.split("/");
  ...
  c.length > 1 && (et(c) === "" ? r === "never" && c.pop() : r === "always" && c.push(""));
  const a = Sr(c.join("/")) || "/";
...
function Gr({ path: e, params: t, decoder: r, ...n }) {
  let s = !1;
  const o = Object.create(null);
  ...
  for (; c < i; ) {
    ...
    if (p === 2) {
      ...
      const m = Gt("_splat", t, r);
      l += "/" + g + m + v;
      continue;
    }
    if (p === 1) {
      const h = e.substring(a[2], a[3]);
      (!s && !(h in t) && (s = !0), (o[h] = t[h]));
      const g = e.substring(f, a[1]),
        v = e.substring(a[4], u),
        m = Gt(h, t, r) ?? "undefined";
      l += "/" + g + m + v;
      continue;
    }
    if (p === 3) {
...
function Go(e) {
  ...
  for (const [n, s] of t.entries()) {
    const o = r[n];
    o == null ? (r[n] = Yt(s)) : Array.isArray(o) ? o.push(Yt(s)) : (r[n] = [o, Yt(s)]);
  }
  return r;
}
const Yo = Xo(JSON.parse),
  Jo = Zo(JSON.stringify, JSON.parse);
function Xo(e) {
  return (t) => {
    t[0] === "?" && (t = t.substring(1));
    const r = Go(t);
...
function ei(e) {
  if (e !== null && typeof e == "object" && e.isSerializedRedirect) return Zn(e);
}
const cr = (e) => {
  ...
  ts = (e, t, r, n) => {
    ...
    if (
      e.onReady &&
      !Nt(e, t) &&
      (r.options.loader || r.options.beforeLoad || ns(r)) &&
      typeof s == "number" &&
      s !== 1 / 0 &&
  ...
  ni = (e, t, r, n) => {
    ...
    (i && Qe(e, r, i), c && Qe(e, r, c), ts(e, t, n, s));
    ...
    const f = () => {
      ...
      u = () => {
        (s._nonReactive.beforeLoadPromise?.resolve(),
          ...
          e.updateMatch(t, (x) => ({ ...x, isFetching: !1 })));
      };
    ...
    const p = { ..._e(e, r, !1), ...s.__routeContext },
      { search: h, params: g, cause: v } = s,
      m = Nt(e, t),
      y = {
        search: h,
        abortController: a,
      ...
      b = (x) => {
        ...
        ((K(x) || U(x)) && (f(), Qe(e, r, x)),
          e.router.batch(() => {
            (f(), e.updateMatch(t, (P) => ({ ...P, __beforeLoadContext: x })), u());
          }));
      };
    let S;
    try {
      if (((S = n.options.beforeLoad(y)), tt(S)))
        return (
          f(),
          S.catch((x) => {
            Qe(e, r, x);
  ...
  Zr = async (e, t, r, n, s) => {
    try {
      ...
      try {
        (!(qn ?? e.router.isServer) || o.ssr === !0) && nt(s);
        ...
        if (
          ...
          (le(e, e.router.getMatch(r), u),
            u !== void 0 && e.updateMatch(r, (p) => ({ ...p, loaderData: u })));
        }
        ...
        (!K(c) && !U(c) && (await nt(s, ["errorComponent"])),
          e.updateMatch(r, (l) => ({
            ...l,
            error: c,
            context: _e(e, n),
  ...
  ii = async (e, t, r) => {
    async function n(h, g, v, m, y) {
      const b = Date.now() - g.updatedAt,
        S = h
        ...
        x = y.options.shouldReload,
        P = typeof x == "function" ? x(rs(e, t, s, r, y)) : x,
        { status: E, invalid: R } = m,
        _ = b >= S && (!!e.forceStaleReload || m.cause === "enter" || (v !== void 0 && v !== m.id));
      ((i = E === "success" && (R || (P ?? _))),
        (h && y.options.preload === !1) ||
          (i && !e.sync && f
            ? ((c = !0),
              (async () => {
                try {
                  await Zr(e, t, s, r, y);
                  const I = e.router.getMatch(s);
                  (I._nonReactive.loaderPromise?.resolve(),
                    I._nonReactive.loadPromise?.resolve(),
                    (I._nonReactive.loaderPromise = void 0),
                    (I._nonReactive.loadPromise = void 0));
                } catch (I) {
                  K(I) && (await e.router.navigate(I.options));
                }
              })())
            : E !== "success" || i
              ? await Zr(e, t, s, r, y)
    ...
    if (es(e, s)) {
      ...
      if (h._nonReactive.loaderPromise) {
        if (h.status === "success" && !e.sync && !h.preload && f) return h;
        await h._nonReactive.loaderPromise;
        const y = e.router.getMatch(s),
          b = y._nonReactive.error || y.error;
        (b && le(e, y, b), y.status === "pending" && (await n(m, h, v, y, a)));
      } else {
        const y = m && !e.router.stores.matchStores.has(s),
          b = e.router.getMatch(s);
        ((b._nonReactive.loaderPromise = Ce()),
          y !== b.preload && e.updateMatch(s, (S) => ({ ...S, preload: y })),
          await n(m, h, v, b, a));
      }
    }
    ...
    const p = c ? u.isFetching : !1;
    return p !== u.isFetching || u.invalid !== !1
      ? (e.updateMatch(s, (h) => ({ ...h, isFetching: p, invalid: !1 })), e.router.getMatch(s))
      : u;
  };
async function en(e) {
  const t = e,
...
function ns(e) {
  for (const t of Rt) if (e.options[t]?.preload) return !0;
  return !1;
}
const Rt = ["component", "errorComponent", "pendingComponent", "notFoundComponent"];
function ai(e) {
  return {
    input: ({ url: t }) => {
      for (const r of e) t = ur(r, t);
      return t;
    },
    output: ({ url: t }) => {
      for (let r = e.length - 1; r >= 0; r--) t = ss(e[r], t);
      return t;
    },
  };
}
function ci(e) {
  const t = Jn(e.basepath),
    r = `/${t}`,
  ...
  const r = new Set(),
    ...
    o = async ({ task: i, navigateOpts: c, ...a }) => {
      ...
      if (typeof document < "u" && l.length && f)
        for (const u of l) {
          const p = Mt(a.path, a.state);
          if (await u.blockerFn({ currentLocation: t, nextLocation: p, action: a.type })) {
            e.onBlocked?.();
            return;
          }
        }
...
function fi(e) {
  ...
  const o = () => s,
    i = (_) => (s = _),
    c = (_) => _,
    a = () => Mt(`${t.location.pathname}${t.location.search}${t.location.hash}`, t.history.state);
  ...
  const b = () => {
    ...
    P = async () => {
      ...
      const _ = a(),
        I = _.state[fe] - l.state[fe],
        M = I === 1,
        L = I === -1,
        A = (!M && !L) || u;
      u = !1;
      const J = A ? "GO" : L ? "BACK" : "FORWARD",
        V = A ? { type: "GO", index: I } : { type: L ? "BACK" : "FORWARD" };
      if (h) h = !1;
      else {
        const ee = o();
        if (typeof document < "u" && ee.length) {
          for (const lt of ee)
            if (await lt.blockerFn({ currentLocation: l, nextLocation: _, action: J })) {
              ((p = !0), t.history.go(1), R.notify(V));
              return;
            }
        }
      }
    ...
    E = (_) => {
      ...
      if (I) return (_.preventDefault(), (_.returnValue = ""));
    },
    R = li({
      getLocation: v,
      getLength: () => t.history.length,
      pushState: (_, I) => S("push", _, I),
      replaceState: (_, I) => S("replace", _, I),
      back: (_) => (_ && (h = !0), (g = !0), t.history.back()),
      forward: (_) => {
        (_ && (h = !0), (g = !0), t.history.forward());
      },
      go: (_) => {
        ((u = !0), t.history.go(_));
      },
      ...
      destroy: () => {
        ((t.history.pushState = r),
          ...
          t.removeEventListener(nn, E, { capture: !0 }),
          t.removeEventListener(rn, P));
      },
      onBlocked: () => {
        f && l !== f && (l = f);
      },
  ...
  return (
    t.addEventListener(nn, E, { capture: !0 }),
    t.addEventListener(rn, P),
    (t.history.pushState = function (..._) {
      const I = r.apply(t.history, _);
      return (R._ignoreSubscribers || x("PUSH"), I);
    }),
    (t.history.replaceState = function (..._) {
      const I = n.apply(t.history, _);
      return (R._ignoreSubscribers || x("REPLACE"), I);
    }),
    R
  );
}
...
var pi = class {
    constructor(e, t) {
      ((this.tempLocationKey = `${Math.round(Math.random() * 1e7)}`),
        ...
        (this.update = (r) => {
          ...
          if (
            ...
            this.options.pathParamsAllowedCharacters &&
              (this.pathParamsDecoder = Qo(this.options.pathParamsAllowedCharacters)),
            ...
            let f;
            ((this.resolvePathCache = rt(1e3)), (f = this.buildRouteTree()), this.setRoutes(f));
          }
          if (!this.stores && this.latestLocation) {
            const f = this.getStoreConfig(this);
            ((this.batch = f.batch), (this.stores = ui(gi(this.latestLocation), f)), Ei(this));
          }
          let c = !1;
          ...
          if (o || s !== a || i !== l) {
            ...
            const f = [],
              u = Jn(a);
            (u && u !== "/" && f.push(ci({ basepath: a })),
              l && f.push(l),
              (this.rewrite = f.length === 0 ? void 0 : f.length === 1 ? f[0] : ai(f)),
              this.history && this.updateLatestLocation(),
              (c = !0));
          }
        ...
        (this.buildRouteTree = () => {
          const r = $o(this.routeTree, this.options.caseSensitive, (n, s) => {
            n.init({ originalIndex: s });
          });
          return (this.options.routeMasks && No(this.options.routeMasks, r.processedTree), r);
        }),
        (this.subscribe = (r, n) => {
        ...
        (this.parseLocation = (r, n) => {
          const s = ({ pathname: a, search: l, hash: f, href: u, state: p }) => {
              if (!this.rewrite && !/[ \x00-\x1f\x7f\u0080-\uffff]/.test(a)) {
                ...
                return {
                  ...
                  external: !1,
                  searchStr: b,
                  search: be(n?.search, y),
                  hash: Ke(f.slice(1)).path,
                  state: xe(n?.state, p),
                };
              }
              const h = new URL(u, this.origin),
                g = ur(this.rewrite, h),
              ...
              return (
                (g.search = m),
                {
                  ...
                  publicHref: u,
                  pathname: Ke(g.pathname).path,
                  external: !!this.rewrite && g.origin !== this.origin,
                  searchStr: m,
                  search: be(n?.search, v),
                  hash: Ke(g.hash.slice(1)).path,
                  state: xe(n?.state, p),
                }
              );
            },
        ...
        (this.getMatchedRoutes = (r) =>
          yi({ pathname: r, routesById: this.routesById, processedTree: this.processedTree })),
        (this.cancelMatch = (r) => {
        ...
        (this.buildLocation = (r) => {
          const n = (o = {}) => {
              ...
              const a = o.unsafeRelative === "path" ? i.pathname : (o.from ?? c.fullPath),
                ...
                p = l?.charCodeAt(0) === 47 ? "/" : this.resolvePathWithBase(a, "."),
                h = l ? this.resolvePathWithBase(p, l) : p,
                g =
                  o.params === !1 || o.params === null
                    ? Object.create(null)
                    : (o.params ?? !0) === !0
                      ? u
                      : Object.assign(u, we(o.params, u)),
                v = this.routesByPath[re(h)];
              let m;
              if (v) m = this.getRouteBranch(v);
              else if (h.includes("$")) m = [];
              else {
                const L = this.getMatchedRoutes(h);
                ((m = L.matchedRoutes),
              ...
              if (r._includeValidateSearch && this.options.search?.strict) {
                ...
                (m.forEach((A) => {
                  if (A.options.validateSearch)
                    try {
                      Object.assign(L, Pt(A.options.validateSearch, { ...L, ...b }));
                    } catch {}
                }),
                  (b = L));
              }
              ((b = vi({
                ...
                (b = be(f, b)));
              const S = this.options.stringifySearch(b),
                x = o.hash === !0 ? i.hash : o.hash ? we(o.hash, i.hash) : void 0,
                P = x ? `#${x}` : "";
              let E = o.state === !0 ? i.state : o.state ? we(o.state, i.state) : {};
              E = xe(i.state, E);
              const R = `${y}${S}${P}`;
              let _,
                I,
            ...
            s = (o = {}, i) => {
              ...
              if (!a) {
                ...
                if (this.options.routeMasks) {
                  const f = Do(c.pathname, this.processedTree);
                  if (f) {
                    Object.assign(l, f.rawParams);
                    const { from: u, params: p, ...h } = f.route,
                      g =
                        p === !1 || p === null
                          ? Object.create(null)
                          : (p ?? !0) === !0
                            ? l
                            : Object.assign(l, we(p, l));
                    ((i = { from: r.from, ...h, params: g }), (a = n(i)));
                  }
                }
              }
        ...
        (this.buildAndCommitLocation = ({
          ...
          if (c) {
            const u = this.history.location.state.__TSR_index,
              p = Mt(c, { __TSR_index: r ? u : u + 1 }),
              h = new URL(p.pathname, this.origin);
            ((a.to = ur(this.rewrite, h).pathname),
              (a.search = this.options.parseSearch(p.search)),
              (a.hash = p.hash.slice(1)));
          }
        ...
        (this.navigate = async ({ to: r, reloadDocument: n, href: s, publicHref: o, ...i }) => {
          ...
          if ((c && !n && (n = !0), n)) {
            ...
            const a = !c && o ? o : s;
            if (It(a, this.protocolAllowlist)) return Promise.resolve();
            if (!i.ignoreBlocker) {
          ...
          for (
            i = new Promise((l) => {
              this.startTransition(async () => {
                try {
                  (this.beforeLoad(),
                    n ? lr.set(this.latestLocation, n) : lr.delete(this.latestLocation));
                  const f = this.latestLocation,
                    u = ke(f, this.stores.resolvedLocation.get());
                        ...
                        this.startTransition(() => {
                          this.startViewTransition(async () => {
                            ...
                            this.batch(() => {
                              ...
                              p = y
                                ? b.filter((P) => !this.stores.pendingMatchStores.has(P.id))
                                : null;
                              const S = new Set();
                              for (const P of this.stores.pendingMatchStores.values())
                                P.routeId && S.add(P.routeId);
                              const x = new Set();
                              for (const P of this.stores.matchStores.values())
                                P.routeId && x.add(P.routeId);
                              ((h = y ? b.filter((P) => !S.has(P.routeId)) : null),
                                (g = y ? m.filter((P) => !x.has(P.routeId)) : null),
                                (v = y ? m.filter((P) => x.has(P.routeId)) : b),
                            ...
                            for (const [m, y] of [
                              ...
                              if (m)
                                for (const b of m) this.looseRoutesById[b.routeId].options[y]?.(b);
                          });
                        });
                      },
                    }));
          ...
          if (
            ...
            if (typeof n == "object" && this.isViewTransitionTypesSupported) {
              const o = this.latestLocation,
                ...
                c = typeof n.types == "function" ? n.types(ke(o, i)) : n.types;
              if (c === !1) {
                r();
                return;
              }
        ...
        (this.resolveRedirect = (r) => {
          ...
          if (
            ...
            It(r.options.href, this.protocolAllowlist)
          )
        ...
        this.update({
          ...
          stringifySearch: e.stringifySearch ?? Jo,
          parseSearch: e.parseSearch ?? Yo,
          protocolAllowlist: e.protocolAllowlist ?? Mo,
        }),
    ...
    getRouteBranch(e) {
      ...
      return (t || ((t = Gn(e)), this.routeBranchCache.set(e, t)), t);
    }
    get looseRoutesById() {
    ...
    matchRoutesInternal(e, t) {
      ...
      const c = i ? wi(this.options.notFoundMode, o) : void 0,
      ...
      for (let f = 0; f < o.length; f++) {
        ...
        let h, g, v;
        {
          const A = p?.search ?? e.search,
            J = p?._strictSearch ?? void 0;
          try {
            const V = Pt(u.options.validateSearch, { ...A }) ?? void 0;
            ((h = { ...A, ...V }), (g = { ...J, ...V }), (v = void 0));
          } catch (V) {
            let ee = V;
            if ((V instanceof Tt || (ee = new Tt(V.message, { cause: V })), t?.throwOnError))
              throw ee;
            ((h = A), (g = {}), (v = ee));
          }
        }
        const m = u.options.loaderDeps?.({ search: h }) ?? "",
          y = m ? JSON.stringify(m) : "",
          { interpolatedPath: b, usedParams: S } = Gr({
            path: u.fullPath,
            params: s,
            decoder: this.pathParamsDecoder,
            server: this.isServer,
        ...
        if (!P)
          try {
            ...
            if ((U(A) || K(A) ? (_ = A) : (_ = new mi(A.message, { cause: A })), t?.throwOnError))
              throw _;
          }
        Object.assign(s, R);
        const I = E ? "stay" : "enter";
        let M;
        if (P)
          M = {
            ...P,
            ...
            params: E?.params ?? s,
            _strictParams: R,
            search: be(E ? E.search : P.search, h),
            _strictSearch: g,
          };
        else {
          const A =
            u.options.loader || u.options.beforeLoad || u.lazyFn || ns(u) ? "pending" : "success";
          M = {
            id: x,
            ssr: u.options.ssr,
            index: f,
            ...
            fetchCount: 0,
            cause: I,
            loaderDeps: E ? xe(E.loaderDeps, m) : m,
            invalid: !1,
            preload: !1,
            links: void 0,
            scripts: void 0,
        ...
        const L = this.getParentContext(p);
        ((M.context = { ...L, ...M.__routeContext, ...M.__beforeLoadContext }), (a[f] = M));
      }
      for (let f = 0; f < a.length; f++) {
        const u = a[f],
          p = this.looseRoutesById[u.routeId],
          h = this.getMatch(u.id),
          g = l.get(u.routeId);
        if (((u.params = g ? be(g.params, s) : s), !h)) {
          const v = a[f - 1],
          ...
          if (p.options.context) {
            ...
            u.__routeContext = p.options.context(y) ?? void 0;
          }
    ...
    matchRoutesLightweight(e) {
      ...
      const o = et(this.stores.matchesId.get()),
...
function Pt(e, t) {
  ...
  if ("~standard" in e) {
    ...
    if (r instanceof Promise) throw new Tt("Async validation not supported");
    if (r.issues) throw new Tt(JSON.stringify(r.issues, void 0, 2), { cause: r });
    return r.value;
  }
  return "parse" in e ? e.parse(t) : typeof e == "function" ? e(t) : {};
}
function yi({ pathname: e, routesById: t, processedTree: r }) {
...
function vi({ search: e, dest: t, destRoutes: r, _includeValidateSearch: n }) {
  return bi(r)(e, t, n ?? !1);
}
function bi(e) {
  let t, r;
  ...
  for (const o of e) {
    ...
    if ("search" in i) i.search?.middlewares && n.push(...i.search.middlewares);
      ...
      const a = ({ search: l, next: f }) => {
        const u = f(i.preSearchFilters ? i.preSearchFilters.reduce((p, h) => h(p), l) : l);
        return i.postSearchFilters ? i.postSearchFilters.reduce((p, h) => h(p), u) : u;
      };
      n.push(a);
    }
    ...
    if (c) {
      const a = ({ search: l, next: f, meta: u }) => {
        ...
        if (r)
          try {
            const h = Pt(c, p);
            if (u && h) for (const g in h) g in p || (u.defaulted ||= new Map()).set(g, h[g]);
            return { ...p, ...h };
          } catch {}
        return p;
      };
...
const Si = "tsr-scroll-restoration-v1_3",
  os = xi();
function Ri() {
  try {
    return JSON.parse(os?.getItem("tsr-scroll-restoration-v1_3") || "{}");
  } catch {
    return {};
  }
}
function Pi() {
  try {
    os?.setItem(Si, JSON.stringify(Te));
  } catch {}
}
const Te = Ri(),
  an = "data-scroll-restoration-id",
  _i = (e) => e.state.__TSR_key || e.href;
function Ci(e) {
...
function Ei(e, t) {
  const r = e.options.scrollRestoration,
    n = e._scroll;
  r && (n.restoring = !0);
  const s = e.options.getScrollRestorationKey || _i,
    o = new Map(),
    i = (l, f, u) => {
      const p = o.get(l) || {};
      ((p.scrollX = f), (p.scrollY = u), o.set(l, p));
    },
    c = (l) => {
      if (!(mt || !n.restoring))
    ...
    a = (l) => {
      ...
      const f = (Te[l] ||= {});
      for (const [u, p] of o) u === Ae ? (f[Ae] = p) : u.isConnected && (f[Ci(u)] = p);
    };
  (r &&
    !n.restoration &&
    ((n.restoration = !0),
    ...
    addEventListener("pagehide", () => {
      (a(s(e.stores.resolvedLocation.get() ?? e.stores.location.get())), Pi());
    })),
    !n.reset &&
      ((n.reset = !0),
      e.subscribe("onRendered", (l) => {
          ...
          if (m) {
            ...
            for (const b in m) {
              if (b === Ae) {
                ...
                const S = fr(b);
                if (!S || (p && u && ((h ??= cn(u)), h.includes(S)))) continue;
              }
              (y || (y = Te[g] = {}), (y[b] ??= m[b]));
            }
          }
        ...
        try {
          ...
          let b = !1;
          if (p) {
            const S = lr.get(l.toLocation),
              x = m && y && (S === "PUSH" || S === "REPLACE"),
              P = n.restoring ? Te[g] : void 0;
            if (P)
              for (const E in P) {
                const { scrollX: R, scrollY: _ } = P[E];
                if (E === Ae) {
                  if (x) continue;
                  (scrollTo({ top: _, left: R, behavior: f }), (b = !0));
                } else {
                  const I = fr(E);
                  I && ((I.scrollLeft = R), (I.scrollTop = _));
                }
              }
            if (!b && !m) {
              const E = { top: 0, left: 0, behavior: f };
              if ((scrollTo(E), u)) {
                h ??= cn(u);
                for (const R of h) R.scrollTo(E);
              }
            }
          }
          !b && m && y && document.getElementById(m)?.scrollIntoView(y);
        } finally {
          mt = !1;
        }
      })));
  ...
  return (
    r[Z] ||
      ...
      r
        ...
        .catch((n) => {
          ((r[Z].status = "error"), (r[Z].error = { data: hi(n), __isServerError: !0 }));
        })),
    r
  );
}
const Li = "Error preloading route! ☝️";
function is(e, t) {
...
function Ti(e, t, r) {
  const n = Ai(t),
    s = is(r, "script") ?? n.crossOrigin;
  return {
    ...(Mi(e) === "iife" ? { rel: "preload", as: "script" } : { rel: "modulepreload" }),
    href: n.href,
    ...(s ? { crossOrigin: s } : {}),
  };
}
      ...
      if (
        ((this.init = (t) => {
          ...
          ((this.parentRoute = this.options.getParentRoute?.()),
            n ? (this._path = Pe) : this.parentRoute || Q());
          let s = n ? Pe : r?.path;
          s && s !== "/" && (s = Yn(s));
          const o = r?.id || s;
          let i = n ? Pe : St([this.parentRoute.id === "__root__" ? "" : this.parentRoute.id, o]);
        ...
        (this.redirect = (t) => Zn({ from: this.fullPath, ...t })),
        (this.options = e || {}),
...
typeof globalThis < "u"
  ...
  : typeof window < "u"
    ...
    : typeof self < "u"
      ...
      : typeof global < "u" &&
        Object.defineProperty(global, yt, {
          value: vt,
          configurable: !0,
          writable: !1,
          enumerable: !1,
...
var zi = ((e) => ((e[(e.Vanilla = 1)] = "Vanilla"), (e[(e.Cross = 2)] = "Cross"), e))(zi || {});
var $i = () => T;
$i.toString();
function qi(e) {
  return {
...
const At = globalThis.Buffer,
  cs = !!At && typeof At.from == "function";
function us(e) {
  if (e.length === 0) return "";
  if (cs) return At.from(e).toString("base64");
  const t = 32768,
    r = [];
    ...
    new ReadableStream({
      start(t) {
        e.on({
          next(r) {
            try {
              typeof r == "string" ? t.enqueue(Wi.encode(r)) : t.enqueue(ls(r.$b64));
            } catch {}
          },
          throw(r) {
            t.error(r);
...
const Yi = {
  ...
  parse: {
    sync(e, t, r) {
      const n = e.hint === "text" ? Ye : Ge;
      return { hint: t.parse(e.hint), factory: t.parse(n), stream: t.parse(at()) };
    },
    async async(e, t, r) {
      const n = e.hint === "text" ? Ye : Ge,
        s = e.hint === "text" ? ln(e.stream) : un(e.stream);
  ...
  deserialize(e, t, r) {
    ...
    return t.deserialize(e.hint) === "text" ? Ki(n) : Vi(n);
  },
};
function Ji(e) {
  return {
...
var ea = {
    ...
    parse: {
      sync(e, t) {
        return { factory: t.parse(ce), stream: t.parse(at()) };
      },
      async async(e, t) {
        return { factory: await t.parse(ce), stream: await t.parse(fn(e)) };
      },
      stream(e, t) {
        return { factory: t.parse(ce), stream: t.parse(fn(e)) };
      },
    },
    serialize(e, t) {
      return "(" + t.serialize(e.factory) + ")(" + t.serialize(e.stream) + ")";
...
const ra = [Xi, Yi, ta];
function na() {
  return [...($n()?.serializationAdapters?.map(qi) ?? []), ...ra];
}
var dn = new TextDecoder(),
  sa = new Uint8Array(0),
  hn = 16 * 1024 * 1024,
  pn = 32 * 1024 * 1024,
  mn = 1024,
...
function oa(e) {
  ...
  function l(u) {
    ...
    if (r.size >= mn) throw new Error(`Too many raw streams in framed response (max ${mn})`);
  ...
  return (
    (async () => {
      ...
      function g() {
        ...
        let b = 0,
          S = 9;
        for (let x = 0; x < p.length && S > 0; x++) {
          const P = p[x],
            E = Math.min(P.length, S);
          (y.set(P.subarray(0, E), b), (b += E), (S -= E));
        }
        return {
          type: y[0],
      ...
      function v(m) {
        ...
        for (; S > 0 && p.length > 0; ) {
          const x = p[0];
          if (!x) break;
          const P = Math.min(x.length, S);
          (y.set(x.subarray(0, P), b),
            (b += P),
            (S -= P),
            P === x.length ? p.shift() : (p[0] = x.subarray(P)));
        }
        return ((h -= m), y);
      }
      try {
        for (;;) {
          ...
          if (s || m) break;
          if (y) {
            if (h + y.length > pn) throw new Error(`Framed response buffer exceeded ${pn} bytes`);
            for (p.push(y), h += y.length; ; ) {
              const b = g();
              if (!b) break;
              const { type: S, streamId: x, length: P } = b;
              if (S !== te.JSON && S !== te.CHUNK && S !== te.END && S !== te.ERROR)
                throw new Error(`Unknown frame type: ${S}`);
              if (S === te.JSON) {
                if (x !== 0) throw new Error("Invalid JSON frame streamId (expected 0)");
              } else if (x === 0) throw new Error("Invalid raw frame streamId (expected non-zero)");
              if (P > hn) throw new Error(`Frame payload too large: ${P} bytes (max ${hn})`);
              const E = 9 + P;
              if (h < E) break;
              if (++i > gn) throw new Error(`Too many frames in framed response (max ${gn})`);
              v(9);
              const R = v(P);
              switch (S) {
                case te.JSON:
                  try {
                    c.enqueue(dn.decode(R));
                  } catch {}
                  break;
                case te.CHUNK: {
                  const _ = f(x);
                ...
                case te.ERROR: {
                  ...
                  if ((n.add(x), _)) {
                    const I = dn.decode(R);
                    (_.error(new Error(I)), t.delete(x));
                  }
                  break;
                }
              }
        ...
        if (h !== 0) throw new Error("Incomplete frame at end of framed response");
        try {
          c.close();
        } catch {}
        (t.forEach((m) => {
...
var ia = ((e) => (
  ...
  ds = Symbol.hasInstance,
  Ne = Symbol.isConcatSpreadable,
  se = Symbol.iterator,
  hs = Symbol.match,
  ps = Symbol.matchAll,
  ms = Symbol.replace,
...
function he(e) {
  ...
  for (let s = 0, o = e.length; s < o; s++)
    ((n = ya(e[s])), n && ((t += e.slice(r, s) + n), (r = s + 1)));
...
function wa(e) {
  if (_s(e)) return Ps.get(e);
  throw new Ja(e);
}
function xa(e) {
  if (ba(e)) return je.get(e);
  throw new Xa(e);
}
typeof globalThis < "u"
  ...
  : typeof window < "u"
    ? Object.defineProperty(window, bt, {
        value: je,
        configurable: !0,
        writable: !1,
        enumerable: !1,
    ...
    : typeof self < "u"
      ...
      : typeof global < "u" &&
        Object.defineProperty(global, bt, {
          value: je,
          configurable: !0,
          writable: !1,
          enumerable: !1,
...
function Ra(e) {
  ...
  return e !== e ? ga : Object.is(e, -0) ? ha : O(0, d, e, d, d, d, d, d, d, d, d, d);
}
function Is(e) {
...
function Ia(e, t) {
  return O(17, e, xs[t], d, d, d, d, d, d, d, d, d);
}
function La(e, t) {
  return O(18, e, he(wa(t)), d, d, d, d, d, d, d, d, d);
}
function Ma(e, t, r) {
  return O(25, e, r, he(t), d, d, d, d, d, d, d, d);
}
function Ta(e, t, r) {
  return O(9, e, d, d, d, d, d, r, d, d, Es(t), d);
}
function Aa(e, t) {
...
var Wa = { parsing: 1, serialization: 2, deserialization: 3 };
function Ka(e) {
  return `Seroval Error (step: ${Wa[e]})`;
}
var Qa = (e, t) => Ka(e),
  Ls = class extends Error {
    constructor(e, t) {
      (super(Qa(e)), (this.cause = t));
    }
  },
  yn = class extends Ls {
    constructor(e) {
...
function Ut(e, t) {
  let r = e.refs.get(t);
  return r != null ? (_t(e, r), { type: 1, value: _a(r) }) : { type: 0, value: wc(e, t) };
}
function _r(e, t) {
  let r = Ut(e, t);
  return r.type === 1 ? r : _s(t) ? { type: 2, value: La(r.value, t) } : r;
}
function Re(e, t) {
  let r = _r(e, t);
  if (r.type !== 0) return r.value;
  if (t in xs) return Ia(r.value, t);
  throw new Dt(t);
}
function zt(e, t) {
  let r = Ut(e, hc[t]);
...
function xc(e) {
  let t = Ut(e, fc);
  return t.type === 1 ? t.value : O(27, t.value, d, d, d, d, d, d, Re(e, se), d, d, d);
}
function Sc(e) {
  let t = Ut(e, dc);
  return t.type === 1 ? t.value : O(29, t.value, d, d, d, d, d, [zt(e, 1), Re(e, ne)], d, d, d, d);
}
function Rc(e, t, r, n) {
  return O(r ? 11 : 10, e, d, d, d, n, d, d, d, d, Es(t), d);
}
function Pc(e, t, r, n) {
  return O(8, t, d, d, d, d, { k: r, v: n }, d, zt(e, 0), d, d, d);
}
function _c(e, t, r) {
  let n = new Uint8Array(r),
    s = "";
  for (let o = 0, i = n.length; o < i; o++) s += String.fromCharCode(n[o]);
  return O(19, t, he(btoa(s)), d, d, d, d, d, zt(e, 5), d, d, d);
}
function Cc(e, t) {
  return { base: bc(e, t), child: void 0 };
}
var Ec = class {
  constructor(e, t) {
  ...
  parse(e) {
    return D(this._p, this.depth, e);
  }
};
async function Ic(e, t, r) {
  let n = [];
  for (let s = 0, o = r.length; s < o; s++) s in r ? (n[s] = await D(e, t, r[s])) : (n[s] = 0);
  return n;
}
async function Lc(e, t, r, n) {
  return Ta(r, n, await Ic(e, t, n));
}
async function Cr(e, t, r) {
  let n = Object.entries(r),
    s = [],
    o = [];
  for (let i = 0, c = n.length; i < c; i++) (s.push(he(n[i][0])), o.push(await D(e, t, n[i][1])));
  return (
    se in r && (s.push(Re(e.base, se)), o.push(Ba(xc(e.base), await D(e, t, cc(r))))),
    ne in r && (s.push(Re(e.base, ne)), o.push(Ua(Sc(e.base), await D(e, t, mc(r))))),
    De in r && (s.push(Re(e.base, De)), o.push(Is(r[De]))),
    Ne in r && (s.push(Re(e.base, Ne)), o.push(r[Ne] ? Ss : Rs)),
    { k: s, v: o }
  );
}
async function Zt(e, t, r, n, s) {
  return Rc(r, n, s, await Cr(e, t, n));
}
async function Mc(e, t, r, n) {
  return Aa(r, await D(e, t, n.valueOf()));
}
async function Tc(e, t, r, n) {
  return Oa(r, n, await D(e, t, n.buffer));
}
async function Ac(e, t, r, n) {
  return ja(r, n, await D(e, t, n.buffer));
}
async function Oc(e, t, r, n) {
  return Fa(r, n, await D(e, t, n.buffer));
}
async function vn(e, t, r, n) {
  let s = Cs(n, e.base.features);
  return ka(r, n, s ? await Cr(e, t, s) : d);
}
async function jc(e, t, r, n) {
  let s = Cs(n, e.base.features);
  return Na(r, n, s ? await Cr(e, t, s) : d);
}
async function Fc(e, t, r, n) {
  let s = [],
    o = [];
  for (let [i, c] of n.entries()) (s.push(await D(e, t, i)), o.push(await D(e, t, c)));
  return Pc(e.base, r, s, o);
}
async function kc(e, t, r, n) {
  let s = [];
  for (let o of n.keys()) s.push(await D(e, t, o));
  return Da(r, s);
}
  ...
  if (s)
    for (let o = 0, i = s.length; o < i; o++) {
      ...
      if (c.parse.async && c.test(n))
        return Ma(r, c.tag, await c.parse.async(n, new Ec(e, t), { id: r }));
    }
  return d;
}
async function Nc(e, t, r, n) {
  let [s, o] = await vc(n);
  return O(12, r, s, d, d, d, d, d, await D(e, t, o), d, d, d);
}
...
async function Bc(e, t, r, n) {
  return za(r, zt(e.base, 4), await new Promise(Dc.bind(e, t, r, n)));
}
async function Uc(e, t, r, n) {
  let s = [];
  for (let o = 0, i = n.v.length; o < i; o++) s[o] = await D(e, t, n.v[o]);
  return Va(r, s, n.t, n.d);
}
async function zc(e, t, r, n) {
  if (Array.isArray(n)) return Lc(e, t, r, n);
  if (pc(n)) return Bc(e, t, r, n);
  if (ac(n)) return Uc(e, t, r, n);
  let s = n.constructor;
  if (s === tc) return D(e, t, n.replacement);
  let o = await js(e, t, r, n);
  if (o) return o;
  switch (s) {
    case Object:
      return Zt(e, t, r, n, !1);
  ...
  if (s === Promise || n instanceof Promise) return Nc(e, t, r, n);
  let i = e.base.features;
  if (i & 32 && s === RegExp) return Ea(r, n);
  if (i & 16)
    switch (s) {
      case BigInt64Array:
      case BigUint64Array:
  ...
  if (i & 1 && typeof AggregateError < "u" && (s === AggregateError || n instanceof AggregateError))
    return jc(e, t, r, n);
  if (n instanceof Error) return vn(e, t, r, n);
  if (se in n || ne in n) return Zt(e, t, r, n, !!s);
  throw new Dt(n);
}
async function $c(e, t, r) {
  let n = _r(e.base, r);
  if (n.type !== 0) return n.value;
  let s = await js(e, t, n.value, r);
  if (s) return s;
  throw new Dt(r);
}
async function D(e, t, r) {
  switch (typeof r) {
    ...
    case "object": {
      if (r) {
        let n = _r(e.base, r);
        return n.type === 0 ? await zc(e, t + 1, n.value, r) : n.value;
      }
      return da;
    }
    case "symbol":
...
async function qc(e, t) {
  try {
    return await D(e, 0, t);
  } catch (r) {
    throw r instanceof yn ? r : new yn(r);
  }
}
var Hc = ((e) => ((e[(e.Vanilla = 1)] = "Vanilla"), (e[(e.Cross = 2)] = "Cross"), e))(Hc || {});
function Fs(e, t) {
  for (let r = 0, n = t.length; r < n; r++) {
    let s = t[r];
    e.has(s) || (e.add(s), s.extends && Fs(e, s.extends));
  }
}
function ks(e) {
  if (e) {
...
function Yc(e, t) {
  ...
  return (
    "types" in n || Object.assign(n, { types: new Map() }),
    {
      ...
      depthLimit: t.depthLimit || Gc,
    }
  );
}
function Jc(e) {
  return { mode: 2, base: Yc(2, e), child: d };
}
var Xc = class {
  constructor(e, t) {
    ((this._p = e), (this.depth = t));
...
function Zc(e, t, r) {
  return (Ds(e.base, t), e.state.marked.has(t) && e.base.refs.set(t, r), r);
}
function eu(e, t, r) {
  return (Ds(e.base, t), e.base.refs.set(t, r), r);
}
function B(e, t, r) {
  return e.mode === 1 ? Zc(e, t, r) : eu(e, t, r);
}
function dr(e, t, r) {
...
function tu(e, t) {
  return B(e, t.i, xa(pe(t.s)));
}
function ru(e, t, r) {
  let n = r.a,
    s = n.length,
    o = B(e, r.i, new Array(s));
  for (let i = 0, c; i < s; i++) ((c = n[i]), c && (o[i] = j(e, t, c)));
  return (Ns(o, r.o), o);
}
function nu(e) {
  switch (e) {
...
function ou(e, t, r, n, s) {
  if (typeof n == "string") bn(r, pe(n), j(e, t, s));
  else {
    let o = j(e, t, n);
    switch (typeof o) {
      case "string":
...
function Us(e, t, r, n) {
  let s = r.k;
  if (s.length > 0) for (let o = 0, i = r.v, c = s.length; o < c; o++) ou(e, t, n, s[o], i[o]);
  return n;
}
function iu(e, t, r) {
  let n = B(e, r.i, r.t === 10 ? {} : Object.create(null));
  return (Us(e, t, r.p, n), Ns(n, r.o), n);
}
function au(e, t) {
...
function uu(e, t, r) {
  ...
  for (let s = 0, o = r.a, i = o.length; s < i; s++) n.add(j(e, t, o[s]));
  return n;
}
function lu(e, t, r) {
  let n = B(e, r.i, new Map());
  for (let s = 0, o = r.e.k, i = r.e.v, c = o.length; s < c; s++)
    n.set(j(e, t, o[s]), j(e, t, i[s]));
  return n;
}
function fu(e, t) {
  if (t.s.length > Wc) throw new ie(t);
  return B(e, t.i, Ts(pe(t.s)));
}
function du(e, t, r) {
  var n;
  let s = Vc(r.c),
...
function yu(e, t, r) {
  return B(e, r.i, Object(j(e, t, r.f)));
}
function vu(e, t, r) {
  ...
  if (n) {
    ...
    for (let o = 0, i = n.length; o < i; o++) {
      let c = n[o];
      if (c.tag === s) return B(e, r.i, c.deserialize(r.s, new Xc(e, t), { id: r.i }));
    }
  }
  throw new Ya(r.c);
}
function bu(e, t) {
  let r = B(e, t.i, B(e, t.s, Bt()).p);
  return (Bs(e, t.s, 22), r);
}
function wu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ut(e, r, r.i, 22), n.s(j(e, t, r.a[1])), d);
  throw new ct("Promise");
}
function xu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ut(e, r, r.i, 22), n.f(j(e, t, r.a[1])), d);
  throw new ct("Promise");
}
function Su(e, t, r) {
  j(e, t, r.a[0]);
...
function Pu(e, t, r) {
  ...
  let s = r.a,
    o = s.length;
  if (o) for (let i = 0; i < o; i++) j(e, t, s[i]);
  return n;
}
function _u(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ut(e, r, r.i, 31), n.next(j(e, t, r.f)), d);
  throw new ct("Stream");
}
function Cu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ut(e, r, r.i, 31), n.throw(j(e, t, r.f)), d);
  throw new ct("Stream");
}
function Eu(e, t, r) {
  let n = e.base.refs.get(r.i);
  if (n) return (ut(e, r, r.i, 31), n.return(j(e, t, r.f)), d);
  throw new ct("Stream");
}
function Iu(e, t, r) {
  return (j(e, t, r.f), d);
...
function Lu(e, t, r) {
  return (j(e, t, r.a[1]), d);
}
function Mu(e, t, r) {
  let n = B(e, r.i, As([], r.s, r.l));
  for (let s = 0, o = r.a.length; s < o; s++) n.v[s] = j(e, t, r.a[s]);
  return n;
}
function j(e, t, r) {
  if (t > e.base.depthLimit) throw new ec(e.base.depthLimit);
  switch (((t += 1), r.t)) {
    case 2:
      return dr(r, ca, r.s);
    case 0:
    ...
    case 3:
      if (String(r.s).length > Kc) throw new ie(r);
      return BigInt(r.s);
    case 4:
...
async function Ou(e, t = {}) {
  let r = ks(t.plugins),
    n = Cc(1, { plugins: r, disabledFeatures: t.disabledFeatures });
  return { t: await qc(n, e), f: n.base.features, m: Array.from(n.base.marked) };
}
var st = null;
async function hr(e) {
...
function $s(e) {
  for (const t in e) if (ju.call(e, t)) return !0;
  return !1;
}
async function Fu(e, t, r) {
  ...
  if (
    ...
    o === "payload" && i.set("accept", `${So}, application/x-ndjson, application/json`),
    n.method === "GET")
  ) {
    if (o === "formData") throw new Error("FormData is not supported with GET requests");
    const a = await qs(n);
    if (a !== void 0) {
      const l = Xn({ payload: a });
      e.includes("?") ? (e += `&${l}`) : (e += `?${l}`);
    }
  }
  let c;
  ...
  return await Nu(async () => s(e, { method: n.method, headers: i, signal: n.signal, body: c }));
}
async function qs(e) {
  let t = !1;
  const r = {};
  if (
    ...
    e.context && $s(e.context) && ((t = !0), (r.context = e.context)),
    t)
  )
    return Hs(r);
}
async function Hs(e) {
  return JSON.stringify(await Promise.resolve(Ou(e, { plugins: st })));
}
async function ku(e) {
  if (e.data instanceof FormData) {
    let r;
    return (
      e.context && $s(e.context) && (r = await Hs(e.context)),
      r !== void 0 && e.data.set(xo, r),
      { body: e.data }
    );
  }
  const t = await qs(e);
...
async function Nu(e) {
  ...
  if ((r || Q(), t.headers.get("x-tss-serialized"))) {
    ...
    if (r.includes("application/x-tss-framed")) {
      if ((_o(r), !t.body)) throw new Error("No response body for framed response");
      const { getOrCreateStream: s, jsonChunks: o } = oa(t.body),
        i = [Ji(s), ...(st || [])],
        c = new Map();
      n = await Du({
        jsonStream: o,
...
async function Du({ jsonStream: e, onMessage: t, onError: r }) {
  const n = e.getReader(),
  ...
  const a = (async () => {
    try {
      for (;;) {
        const { value: u, done: p } = await n.read();
        if (p) break;
        if (u)
          try {
            const h = [];
...
function Bu(e) {
  ...
  return Object.assign(
    (...s) => {
      const o = $n()?.serverFns?.fetch;
      return Fu(t, s, o ?? fetch);
    },
    { url: t, serverFnMeta: { id: e }, [ar]: !0 },
  );
}
var Uu = {
  key: "$TSS/serverfn",
  test: (e) => (typeof e != "function" || !(ar in e) ? !1 : !!e[ar]),
  toSerializable: ({ serverFnMeta: e }) => ({ functionId: e.id }),
  fromSerializable: ({ functionId: e }) => Bu(e),
};
function xn(e) {
...
async function $u(e) {
  ...
  (r.matches.forEach((m) => {
    ...
    r.lastMatchId && (r.lastMatchId = xn(r.lastMatchId)));
  ...
  let u;
  (c.forEach((m) => {
    const y = r.matches.find((b) => b.i === m.id);
    if (!y) {
  ...
  await Promise.all(
    p.map(async (m) => {
      try {
        const y = e.looseRoutesById[m.routeId],
          b = p[m.index - 1]?.context ?? e.options.context;
        if (y.options.context) {
          const E = {
            ...
            context: b ?? {},
            location: h,
            navigate: (R) => e.navigate({ ...R, _fromLocation: h }),
          ...
          m.__routeContext = y.options.context(E) ?? void 0;
        }
        ...
        const S = {
          ...
          x = await y.options.head?.(S),
          P = await y.options.scripts?.(S);
        ((m.meta = x?.meta),
          (m.links = x?.links),
          (m.headScripts = x?.scripts),
          (m.styles = x?.styles),
          (m.scripts = P));
      } catch (y) {
        if (U(y))
...
var Ot = C.use,
  Xe = typeof window < "u" ? C.useLayoutEffect : C.useEffect;
function er(e) {
  const t = C.useRef({ value: e, prev: null }),
    r = t.current.value;
...
function Wu(e) {
  const t = w.jsx(Ku, { ...e });
  return e.fallback ? w.jsx(C.Suspense, { fallback: e.fallback, children: t }) : t;
}
function Ku(e) {
  const t = Vu(e);
  return e.children(t);
...
function Er(e) {
  const t = e.errorComponent ?? Ir;
  return w.jsx(Qu, {
    getResetKey: e.getResetKey,
    onCatch: e.onCatch,
    children: ({ error: r, reset: n }) =>
      r ? C.createElement(t, { error: r, reset: n }) : e.children,
  });
}
var Qu = class extends C.Component {
  constructor(...e) {
      ...
      t
        ? w.jsx("div", {
            children: w.jsx("pre", {
              ...
              children: e.message ? w.jsx("code", { children: e.message }) : null,
            }),
          })
        : null,
    ],
...
function Gu({ children: e, fallback: t = null }) {
  return Lr() ? w.jsx(Ze.Fragment, { children: e }) : w.jsx(Ze.Fragment, { children: t });
}
function Lr() {
...
var Vs = C.createContext(null);
function z(e) {
  return C.useContext(Vs);
}
var $t = C.createContext(void 0),
  Ju = C.createContext(void 0),
  k = ((e) => (
    (e[(e.None = 0)] = "None"),
...
function Xu({ update: e, notify: t, unwatched: r }) {
  return { link: n, unlink: s, propagate: o, checkDirty: i, shallowPropagate: c };
  function n(l, f, u) {
    const p = f.depsTail;
    if (p !== void 0 && p.dep === l) return;
    const h = p !== void 0 ? p.nextDep : f.deps;
    if (h !== void 0 && h.dep === l) {
      ((h.version = u), (f.depsTail = h));
      return;
    }
    const g = l.subsTail;
    ...
    const v =
      (f.depsTail =
      l.subsTail =
        { version: u, dep: l, sub: f, prevDep: p, nextDep: h, prevSub: g, nextSub: void 0 });
    (h !== void 0 && (h.prevDep = v),
      p !== void 0 ? (p.nextDep = v) : (f.deps = v),
  ...
  function s(l, f = l.sub) {
    const u = l.dep,
      ...
      v = l.prevSub;
    return (
      h !== void 0 ? (h.prevDep = p) : (f.depsTail = p),
      p !== void 0 ? (p.nextDep = h) : (f.deps = h),
...
const {
  ...
  notify(e) {
    ((pr[mr++] = e), (e.flags &= ~k.Watching));
  },
  unwatched(e) {
    e.depsTail !== void 0 && ((e.depsTail = void 0), (e.flags = k.Mutable | k.Dirty), jt(e));
  },
});
let wt = 0,
  mr = 0,
...
function jt(e) {
  ...
  for (; r !== void 0; ) r = el(r, e);
}
function Qs() {
  if (!(gr > 0)) {
    for (; wt < mr; ) {
      const e = pr[wt];
      ((pr[wt++] = void 0), e.notify());
    }
    ((wt = 0), (mr = 0));
  }
}
function Pn(e, t) {
  const r = typeof e == "function",
    ...
    s = {
      ...
      deps: void 0,
      depsTail: void 0,
      flags: r ? k.None : k.Mutable,
      get() {
        return (X !== void 0 && Sn(s, X, Ct), s._snapshot);
      },
      subscribe(o) {
        const i = Zu(o),
          c = { current: !1 },
      ...
      _update(o) {
        ...
        if (r) ((X = s), ++Ct, (s.depsTail = void 0));
        else if (o === void 0) return !1;
        r && (s.flags = k.Mutable | k.RecursedCheck);
        try {
          const a = s._snapshot,
            l = typeof o == "function" ? o(a) : o === void 0 && r ? n(a) : o;
          return a === void 0 || !c(a, l) ? ((s._snapshot = l), !0) : !1;
        } finally {
          ((X = i), r && (s.flags &= ~k.RecursedCheck), jt(s));
        }
      },
    };
  return (
    r
      ? ((s.flags = k.Mutable | k.Dirty),
        (s.get = function () {
          const o = s.flags;
          if (o & k.Dirty || (o & k.Pending && Ws(s.deps, s))) {
            if (s._update()) {
              const i = s.subs;
              i !== void 0 && Rn(i);
            }
          } else o & k.Pending && (s.flags = o & ~k.Pending);
          return (X !== void 0 && Sn(s, X, Ct), s._snapshot);
        }))
      : (s.set = function (o) {
          if (s._update(o)) {
            const i = s.subs;
            i !== void 0 && (tl(i), Rn(i), Qs());
          }
        }),
    s
  );
...
function rl(e) {
  const t = () => {
      const n = X;
      ((X = r), ++Ct, (r.depsTail = void 0), (r.flags = k.Watching | k.RecursedCheck));
      try {
        return e();
      } finally {
        ((X = n), (r.flags &= ~k.RecursedCheck), jt(r));
      }
    },
    r = {
      deps: void 0,
      ...
      notify() {
        const n = this.flags;
        n & k.Dirty || (n & k.Pending && Ws(this.deps, this)) ? t() : (this.flags = k.Watching);
      },
      stop() {
        ((this.flags = k.None), (this.depsTail = void 0), jt(this));
      },
    };
  return (t(), r);
}
...
function nl() {
  ...
  function c(u, p) {
    var h = p(),
      g = n({ inst: { value: h, getSnapshot: p } }),
      v = g[0].inst,
      m = g[1];
    return (
      o(
        function () {
          ((v.value = h), (v.getSnapshot = p), a(v) && m({ inst: v }));
        },
        [u, h, p],
      ),
      s(
  ...
  var f =
    ...
    typeof window.document.createElement > "u"
      ...
      : c;
  return (
    (sr.useSyncExternalStore = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : f),
    sr
  );
}
var Cn;
function sl() {
  return (Cn || ((Cn = 1), (nr.exports = nl())), nr.exports);
}
var En;
function ol() {
  if (En) return rr;
  ...
  var n = typeof Object.is == "function" ? Object.is : r,
    ...
    a = e.useDebugValue;
  return (
    (rr.useSyncExternalStoreWithSelector = function (l, f, u, p, h) {
      var g = o(null);
      if (g.current === null) {
      ...
      g = c(
        function () {
          function y(E) {
            if (!b) {
              if (((b = !0), (S = E), (E = p(E)), h !== void 0 && v.hasValue)) {
                var R = v.value;
                if (h(R, E)) return (x = R);
              }
              return (x = E);
            }
            if (((R = x), n(S, E))) return R;
            var _ = p(E);
            return h !== void 0 && h(R, _) ? ((S = E), R) : ((S = E), (x = _));
          }
          var b = !1,
            S,
            x,
...
var In;
function il() {
  return (In || ((In = 1), (tr.exports = ol())), tr.exports);
}
var al = il();
function cl(e, t) {
  return e === t;
...
function N(e, t, r = cl) {
  const n = C.useCallback(
    ...
    s = C.useCallback(() => e?.get(), [e]);
  return al.useSyncExternalStoreWithSelector(n, s, s, t, r);
}
var ul = { get: () => {}, subscribe: () => ({ unsubscribe: () => {} }) };
function Ee(e) {
  const t = z(),
    r = C.useContext(e.from ? Ju : $t),
    n = e.from ?? r,
...
function Zs(e) {
  const t = z();
  return C.useCallback((r) => t.navigate({ ...r, from: r.from ?? e?.from }), [e?.from, t]);
}
function eo(e) {
...
function ll(e, t) {
  const r = z(),
    ...
    $ = C.useMemo(() => {
      const F = { _fromLocation: ge, ...He };
      return r.buildLocation(F);
    }, [r, ge, He]),
    Fr = $.maskedLocation ? $.maskedLocation.publicHref : $.publicHref,
    kr = $.maskedLocation ? $.maskedLocation.external : $.external,
    Ve = C.useMemo(() => gl(Fr, kr, r.history, b), [b, kr, Fr, r.history]),
    We = C.useMemo(() => {
      if (Ve?.external) return It(Ve.href, r.protocolAllowlist) ? void 0 : Ve.href;
      if (!yl(c) && !(typeof c != "string" || c.indexOf(":") === -1))
        try {
          return (new URL(c), It(c, r.protocolAllowlist) ? void 0 : c);
        } catch {}
    }, [c, Ve, r.protocolAllowlist]),
    Vt = C.useMemo(() => {
      if (We) return !1;
      if (i?.exact) {
        if (!Wo(ge.pathname, $.pathname, r.basepath)) return !1;
      } else {
        const F = Lt(ge.pathname, r.basepath),
          W = Lt($.pathname, r.basepath);
        if (!(F.startsWith(W) && (F.length === W.length || F[W.length] === "/"))) return !1;
      }
      return (i?.includeSearch ?? !0) &&
        !q(ge.search, $.search, { partial: !i?.exact, ignoreUndefined: !i?.explicitUndefined })
        ? !1
        : i?.includeHash
          ? Ht && ge.hash === $.hash
          : !0;
    ...
    ft = Vt ? (we(s, {}) ?? fl) : or,
    dt = Vt ? or : (we(o, {}) ?? or),
    Nr = [x, ft.className, dt.className].filter(Boolean).join(" "),
    Dr = (S || ft.style || dt.style) && { ...S, ...ft.style, ...dt.style },
    [mo, Br] = C.useState(!1),
    Ur = C.useRef(!1),
    Le = e.reloadDocument || We ? !1 : (a ?? r.options.defaultPreload),
    Wt = l ?? r.options.defaultPreloadDelay ?? 0,
    ye = C.useCallback(() => {
      r.preloadRoute({ ...He, _builtLocation: $ }).catch((F) => {
        (console.warn(F), console.warn(Li));
      });
    }, [r, He, $]);
  (qu(
    n,
    ...
    ml,
    { disabled: !!b || Le !== "viewport" },
  ),
    C.useEffect(() => {
      Ur.current || (!b && Le === "render" && (ye(), (Ur.current = !0)));
    }, [b, ye, Le]));
  const go = (F) => {
    const W = F.currentTarget.getAttribute("target"),
      ve = y !== void 0 ? y : W;
    if (!b && !vl(F) && !F.defaultPrevented && (!ve || ve === "_self") && F.button === 0) {
      (F.preventDefault(),
        bo.flushSync(() => {
          Br(!0);
        }));
      const vo = r.subscribe("onResolved", () => {
        (vo(), Br(!1));
      });
      r.navigate({
        ...He,
  ...
  const zr = (F) => {
    ...
    $r = (F) => {
      ...
      const W = F.currentTarget,
        ve = Je.get(W);
      ve && (clearTimeout(ve), Je.delete(W));
    };
  return {
    ...Ie,
    ...ft,
    ...
    onBlur: Me([E, $r]),
    onFocus: Me([R, zr]),
    onMouseEnter: Me([_, zr]),
    onMouseLeave: Me([I, $r]),
    onTouchStart: Me([M, yo]),
    disabled: !!b,
    target: y,
    ...(Dr && { style: Dr }),
    ...(Nr && { className: Nr }),
...
var or = {},
  fl = { className: "active" },
  dl = { role: "link", "aria-disabled": !0 },
  hl = { "data-status": "active", "aria-current": "page" },
  pl = { "data-transitioning": "transitioning" },
  Je = new WeakMap(),
  ml = { rootMargin: "100px" },
  Me = (e) => (t) => {
    for (const r of e)
...
var Mr = C.forwardRef((e, t) => {
  ...
  if (!r) {
    ...
    return C.createElement("a", a, i);
  }
  return C.createElement(r, o, i);
});
function vl(e) {
  return !!(e.metaKey || e.altKey || e.ctrlKey || e.shiftKey);
}
var bl = class extends as {
  constructor(t) {
    (super(t),
      (this.useMatch = (r) =>
        Ee({ select: r?.select, from: this.id, structuralSharing: r?.structuralSharing })),
      (this.useRouteContext = (r) => eo({ ...r, from: this.id })),
      (this.useSearch = (r) =>
        Xs({ select: r?.select, structuralSharing: r?.structuralSharing, from: this.id })),
      (this.useParams = (r) =>
        Js({ select: r?.select, structuralSharing: r?.structuralSharing, from: this.id })),
      (this.useLoaderDeps = (r) => Ys({ ...r, from: this.id })),
      (this.useLoaderData = (r) => Gs({ ...r, from: this.id })),
      (this.useNavigate = () => Zs({ from: this.fullPath })),
      (this.Link = Ze.forwardRef((r, n) => w.jsx(Mr, { ref: n, from: this.fullPath, ...r }))));
  }
};
function wl(e) {
  return new bl(e);
...
var Sl = class extends ji {
  constructor(e) {
    (super(e),
      ...
      (this.useRouteContext = (t) => eo({ ...t, from: this.id })),
      (this.useSearch = (t) =>
        Xs({ select: t?.select, structuralSharing: t?.structuralSharing, from: this.id })),
      (this.useParams = (t) =>
        Js({ select: t?.select, structuralSharing: t?.structuralSharing, from: this.id })),
      (this.useLoaderDeps = (t) => Ys({ ...t, from: this.id })),
      (this.useLoaderData = (t) => Gs({ ...t, from: this.id })),
      (this.useNavigate = () => Zs({ from: this.fullPath })),
      (this.Link = Ze.forwardRef((t, r) => w.jsx(Mr, { ref: r, from: this.fullPath, ...t }))));
  }
};
function Rl(e) {
  return new Sl(e);
...
function Be(e) {
  return new Pl(e, { silent: !0 }).createRoute;
}
var Pl = class {
  constructor(e, t) {
    ((this.path = e),
...
function Ue(e, t) {
  ...
  const i = () => (
      r ||
        (r = e()
          ...
          .catch((a) => {
            if (
              ((s = a),
              Io(s) && s instanceof Error && typeof window < "u" && typeof sessionStorage < "u")
            ) {
    ...
    c = function (l) {
      ...
      return C.createElement(n, l);
    };
  return ((c.preload = i), c);
}
function _l(e) {
  const t = z(),
    r = `not-found-${N(t.stores.location, (n) => n.pathname)}-${N(t.stores.status, (n) => n)}`;
  return w.jsx(Er, {
    getResetKey: () => r,
    onCatch: (n, s) => {
...
function Oe(e) {
  return w.jsx(w.Fragment, { children: e.children });
}
function to(e, t, r) {
  return t.options.notFoundComponent
    ? w.jsx(t.options.notFoundComponent, { ...r })
    : e.options.defaultNotFoundComponent
      ? w.jsx(e.options.defaultNotFoundComponent, { ...r })
      : w.jsx(Cl, {});
}
function El(e) {
  return null;
...
var ro = C.memo(function ({ matchId: t }) {
  const r = z(),
    n = r.stores.matchStores.get(t);
  n || Q();
  const s = N(r.stores.loadedAt, (i) => i),
    o = N(n, (i) => i);
  return w.jsx(Ll, {
    router: r,
    matchId: t,
    resetKey: s,
    matchState: C.useMemo(() => {
      const i = o.routeId,
...
function Ll({ router: e, matchId: t, resetKey: r, matchState: n }) {
  const s = e.routesById[n.routeId],
    ...
    p = c ? Er : Oe,
    h = l ? _l : Oe;
  return w.jsxs(s.isRoot ? (s.options.shellComponent ?? Oe) : Oe, {
    children: [
      w.jsx($t.Provider, {
        value: t,
        children: w.jsx(u, {
            ...
            children: w.jsx(h, {
              fallback: (g) => {
                if (
                  ...
                  throw g;
                return C.createElement(l, g);
              },
              children:
                f || n._displayPending
                  ? w.jsx(Gu, { fallback: i, children: w.jsx(Ln, { matchId: t }) })
                  : w.jsx(Ln, { matchId: t }),
            }),
          }),
        }),
      ...
      n.parentRouteId === Pe
        ? w.jsxs(w.Fragment, {
            children: [
              w.jsx(Ml, { resetKey: r }),
              e.options.scrollRestoration && qn ? w.jsx(Il, {}) : null,
            ],
          })
        : null,
    ],
  ...
  return (
    Xe(() => {
      ...
      (r.current === void 0 || r.current !== n) &&
        (t.emit({
          type: "onRendered",
          ...ke(t.stores.location.get(), t.stores.resolvedLocation.get()),
        }),
        (r.current = n));
...
var Ln = C.memo(function ({ matchId: t }) {
    const r = z(),
    ...
    if (o.status === "pending") {
      ...
      if (f) {
        ...
        if (u && !u._nonReactive.minPendingPromise) {
          const p = Ce();
          ((u._nonReactive.minPendingPromise = p),
            setTimeout(() => {
              (p.resolve(), (u._nonReactive.minPendingPromise = void 0));
            }, f));
        }
      }
      throw n(o, "loadPromise");
    }
    if (o.status === "notFound") return (U(o.error) || Q(), to(r, c, o.error));
  ...
  no = C.memo(function () {
      ...
      o;
    {
      ...
      (([n, s] = N(l, (f) => [f?.routeId, f?.globalNotFound ?? !1])),
        (o = N(t.stores.matchesId, (f) => f[f.findIndex((u) => u === r) + 1])));
    }
    const i = n ? t.routesById[n] : void 0,
      c = t.options.defaultPendingComponent ? w.jsx(t.options.defaultPendingComponent, {}) : null;
    if (s) return (i || Q(), to(t, i, void 0));
    if (!o) return null;
    const a = w.jsx(ro, { matchId: o });
    return n === Pe ? w.jsx(C.Suspense, { fallback: c, children: a }) : a;
  });
function Tl() {
  const e = z(),
    t = C.useRef({ router: e, mounted: !1 }),
    [r, n] = C.useState(!1),
    s = N(e.stores.isLoading, (u) => u),
    o = N(e.stores.hasPending, (u) => u),
    i = er(s),
    c = s || r || o,
    a = er(c),
    l = s || o,
  ...
  return (
    ...
    C.useEffect(() => {
      ...
      return (
        re(e.latestLocation.publicHref) !== re(p.publicHref) &&
    ...
    Xe(() => {
      i &&
        !s &&
        e.emit({ type: "onLoad", ...ke(e.stores.location.get(), e.stores.resolvedLocation.get()) });
    }, [i, e, s]),
    Xe(() => {
      f &&
        !l &&
        e.emit({
          ...
          ...ke(e.stores.location.get(), e.stores.resolvedLocation.get()),
        });
    }, [l, f, e]),
    Xe(() => {
      if (a && !c) {
        const u = ke(e.stores.location.get(), e.stores.resolvedLocation.get());
...
function Al() {
  const e = z(),
    t = e.routesById[Pe].options.pendingComponent ?? e.options.defaultPendingComponent,
    r = t ? w.jsx(t, {}) : null,
    n = w.jsxs(typeof document < "u" && e.ssr ? Oe : C.Suspense, {
      fallback: r,
      children: [w.jsx(Tl, {}), w.jsx(Ol, {})],
    });
  return e.options.InnerWrap ? w.jsx(e.options.InnerWrap, { children: n }) : n;
}
function Ol() {
  const e = z(),
    t = N(e.stores.firstId, (s) => s),
    r = N(e.stores.loadedAt, (s) => s),
    n = t ? w.jsx(ro, { matchId: t }) : null;
  return w.jsx($t.Provider, {
    value: t,
    children: e.options.disableGlobalCatchBoundary
      ? n
      : w.jsx(Er, { getResetKey: () => r, errorComponent: Ir, onCatch: void 0, children: n }),
  });
}
var jl = (e) => ({ createMutableStore: Pn, createReadonlyStore: Pn, batch: Ks }),
  Fl = (e) => new kl(e),
  kl = class extends pi {
    constructor(e) {
      super(e, jl);
...
function Nl({ router: e, children: t, ...r }) {
  Vn(r) && e.update({ ...e.options, ...r, context: { ...e.options.context, ...r.context } });
  const n = w.jsx(Vs.Provider, { value: e, children: t });
  return e.options.Wrap ? w.jsx(e.options.Wrap, { children: n }) : n;
}
function Dl({ router: e, ...t }) {
  return w.jsx(Nl, { router: e, ...t, children: w.jsx(Al, {}) });
}
function Mn(e, t) {
  if (t)
...
function so(e) {
  ...
  switch (e.tag) {
    case "title":
      return w.jsx("title", { ...t, suppressHydrationWarning: !0, children: r });
    case "meta":
      return w.jsx("meta", { ...t, suppressHydrationWarning: !0 });
    case "link":
      return w.jsx("link", {
        ...t,
    ...
    case "style":
      return (
        e.inlineCss,
        w.jsx("style", { ...t, dangerouslySetInnerHTML: { __html: r }, nonce: n })
      );
    case "script":
      return w.jsx(Bl, { attrs: t, preventScriptHoist: s, children: r });
    default:
      return null;
  }
}
function Bl({ attrs: e, children: t, preventScriptHoist: r }) {
  z();
  const n = Lr(),
    s =
    ...
    (C.useEffect(() => {
      if (!s) {
        if (e?.src) {
          ...
          return (Mn(i, e), document.head.appendChild(i), () => i.remove());
        }
        if (typeof t == "string") {
          ...
          return ((c.textContent = t), Mn(c, e), document.head.appendChild(c), () => c.remove());
        }
      }
    }, [e, t, s]),
    s && typeof t == "string")
  ...
  if (!n) {
    if (e?.src) return w.jsx("script", { ...e, suppressHydrationWarning: !0 });
    if (typeof t == "string")
      return w.jsx("script", {
        ...e,
        dangerouslySetInnerHTML: { __html: t },
...
var Ul = (e) => {
  const t = z(),
    ...
    n = N(t.stores.matches, (u) => u.map((p) => p.meta).filter((p) => p !== void 0), q),
    s = C.useMemo(() => {
      const u = [],
        p = {};
      let h;
          ...
          if (y)
            if (y.title) h || (h = { tag: "title", children: y.title });
              ...
              try {
                ...
                u.push({ tag: "script", attrs: { type: "application/ld+json" }, children: Oo(b) });
              } catch {}
            else {
    ...
    o = N(
      ...
      (u) =>
        u
          .flatMap((p) => p.links ?? [])
          .filter((p) => p !== void 0)
          .map((p) => ({ tag: "link", attrs: { ...p, nonce: r } })),
      q,
    ),
    i = N(
      t.stores.matches,
      (u) => {
        const p = t.ssr?.manifest,
          h = [];
        return (
          p &&
            (u.forEach((g) => {
              p.routes[g.routeId]?.css?.forEach((v) => {
                const m = Oi(v);
                h.push({
                  tag: "link",
                  attrs: {
                    rel: "stylesheet",
                    ...m,
                    crossOrigin: is(e, "stylesheet") ?? m.crossOrigin,
                    suppressHydrationWarning: !0,
                    nonce: r,
                  },
                });
            ...
            p.inlineStyle &&
              h.push({
                tag: "style",
                attrs: { ...p.inlineStyle.attrs, nonce: r },
                children: p.inlineStyle.children,
                inlineCss: !0,
              })),
          h
        );
    ...
    c = N(
      ...
      (u) => {
        ...
        return (
          h &&
            u.forEach((g) => {
              h.routes[g.routeId]?.preloads?.forEach((v) => {
                p.push({ tag: "link", attrs: { ...Ti(h, v, e), nonce: r } });
              });
            }),
          p
        );
    ...
    f = [];
  return (gt(f, s), f.push(...c), gt(f, o), f.push(...i), gt(f, a), gt(f, l), f);
};
function zl(e) {
  const t = Ul(e.assetCrossOrigin),
    r = z().options.ssr?.nonce;
  return w.jsx(w.Fragment, {
    children: t.map((n) =>
      C.createElement(so, { ...n, key: `tsr-meta-${JSON.stringify(n)}`, nonce: r }),
    ),
  });
}
var $l = () => {
  const e = z(),
    ...
    s = N(e.stores.matches, r, q);
  return ql(e, N(e.stores.matches, n, q), s);
};
function ql(e, t, r) {
  const n = [...t, ...r];
  return w.jsx(w.Fragment, {
    children: n.map((s, o) => C.createElement(so, { ...s, key: `tsr-scripts-${s.tag}-${o}` })),
  });
}
var Fe = (e, t) => {
...
function oo(e, t) {
  for (let r = 0, n = t.length; r < n; r++) {
    const s = t[r];
    e.has(s) || (e.add(s), s.extends && oo(e, s.extends));
  }
}
var Hl = (e) => ({
  getOptions: async () => {
    ...
    if (t.serializationAdapters) {
      const r = new Set();
      (oo(r, t.serializationAdapters), (t.serializationAdapters = Array.from(r)));
    }
    return t;
  },
  createMiddleware: Fe,
...
var Yl = typeof window > "u" || "Deno" in globalThis;
function Y() {}
function Jl(e, t) {
...
function An(e, t) {
  ...
  if (i) {
    if (n) {
      if (t.queryHash !== Tr(i, t.options)) return !1;
    } else if (!it(t.queryKey, i)) return !1;
  }
  if (r !== "all") {
    const a = t.isActive();
...
function On(e, t) {
  ...
  if (o) {
    ...
    if (r) {
      if (ot(t.options.mutationKey) !== ot(o)) return !1;
    } else if (!it(t.options.mutationKey, o)) return !1;
  }
  ...
  return e === t
    ...
    : typeof e != typeof t
      ...
      : e && t && typeof e == "object" && typeof t == "object"
        ? Object.keys(t).every((r) => it(e[r], t[r]))
        : !1;
}
...
function ao(e, t, r = 0) {
  ...
  for (let f = 0; f < c; f++) {
    const u = n ? f : i[f],
      ...
      h = t[u];
    if (p === h) {
      ((a[u] = p), (n ? f < o : tf.call(e, u)) && l++);
      continue;
    }
    if (p === null || h === null || typeof p != "object" || typeof h != "object") {
      a[u] = h;
      continue;
    }
    const g = ao(p, h, r + 1);
...
function lo(e) {
  return (e ?? "online") === "online" ? Ft.isOnline() : !0;
}
...
function fo(e) {
  ...
  const s = cf(),
    ...
    l = () => io.isFocused() && (e.networkMode === "always" || Ft.isOnline()) && e.canRun(),
    f = () => lo(e.networkMode) && e.canRun(),
    u = (v) => {
      o() || (n?.(), s.resolve(v));
    },
    p = (v) => {
    ...
    g = () => {
      ...
      Promise.resolve(v)
        ...
        .catch((y) => {
          if (o()) return;
          const b = e.retry ?? (uo.isServer() ? 0 : 3),
            S = e.retryDelay ?? df,
            x = typeof S == "function" ? S(r, y) : S,
            P = b === !0 || (typeof b == "number" && r < b) || (typeof b == "function" && b(r, y));
          if (t || !P) {
            p(y);
            return;
          }
...
var ho = class {
  ...
  updateGcTime(e) {
    this.gcTime = Math.max(this.gcTime || 0, e ?? (uo.isServer() ? 1 / 0 : 300 * 1e3));
  }
  clearGcTimeout() {
        ...
        const u = (g) => {
          ...
          h = async (g, v, m) => {
            ...
            const b = (() => {
              ...
              P = m ? of : sf;
            return { pages: P(g.pages, S, x), pageParams: P(g.pageParams, v, x) };
          };
        if (s && o.length) {
          const g = s === "backward",
            v = g ? pf : kn,
          ...
          const g = e ?? o.length;
          do {
            const v = a === 0 ? (i[0] ?? n.initialPageParam) : kn(n, c);
            if (a > 0 && v == null) break;
            ((c = await h(c, v)), a++);
          } while (a < g);
        }
...
var mf = class extends ho {
  ...
  setOptions(e) {
    if (
      ...
      t.data !== void 0 && (this.setState(Nn(t.data, t.dataUpdatedAt)), (this.#t = t));
    }
  }
  optionalRemove() {
  ...
  setData(e, t) {
    const r = nf(this.state.data, e, this.options);
    return (
  ...
  isActive() {
    return this.observers.some((e) => ef(e.options.enabled, this) !== !1);
  }
  isDisabled() {
    return this.getObserversCount() > 0
      ? !this.isActive()
      : this.options.queryFn === Ar || !this.isFetched();
  }
  isFetched() {
  ...
  isStatic() {
    return this.getObserversCount() > 0
      ? this.observers.some((e) => vr(e.options.staleTime, this) === "static")
      : !1;
  }
  isStale() {
    return this.getObserversCount() > 0
  ...
  async fetch(e, t) {
    ...
    ((this.#e === "infinite" ? hf(this.options.pages) : this.options.behavior)?.onFetch(i, this),
      (this.#r = this.state),
  ...
  #a(e) {
    const t = (r) => {
      switch (e.type) {
        ...
        case "fetch":
          return { ...r, ...gf(r.data, this.options), fetchMeta: e.meta ?? null };
        case "success":
          const n = {
            ...r,
...
function gf(e, t) {
  return {
    fetchFailureCount: 0,
    fetchFailureReason: null,
    fetchStatus: lo(t.networkMode) ? "fetching" : "paused",
...
var bf = class extends qt {
  ...
  find(e) {
    const t = { exact: !0, ...e };
    return this.getAll().find((r) => On(t, r));
  }
  findAll(e = {}) {
...
var wf = class extends qt {
  ...
  xf = class {
    ...
    #i;
    constructor(e = {}) {
      ((this.#e = e.queryCache || new wf()),
        (this.#t = e.mutationCache || new bf()),
    ...
    mount() {
      (this.#n++,
        this.#n === 1 &&
          ((this.#c = io.subscribe(async (e) => {
            e && (await this.resumePausedMutations(), this.#e.onFocus());
          })),
          (this.#i = Ft.subscribe(async (e) => {
    ...
    ensureQueryData(e) {
      ...
      return n === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale && r.isStaleByTime(vr(t.staleTime, r)) && this.prefetchQuery(t),
          Promise.resolve(n));
    }
    getQueriesData(e) {
    ...
    fetchQuery(e) {
      ...
      return r.isStaleByTime(vr(t.staleTime, r)) ? r.fetch(t) : Promise.resolve(r.state.data);
    }
    prefetchQuery(e) {
    ...
    setQueryDefaults(e, t) {
      this.#s.set(ot(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      ...
      return (
        t.forEach((n) => {
          it(e, n.queryKey) && Object.assign(r, n.defaultOptions);
        }),
        r
      );
    }
    setMutationDefaults(e, t) {
      this.#o.set(ot(e), { mutationKey: e, defaultOptions: t });
    }
    getMutationDefaults(e) {
      ...
      return (
        t.forEach((n) => {
          it(e, n.mutationKey) && Object.assign(r, n.defaultOptions);
        }),
        r
      );
    }
    defaultQueryOptions(e) {
      ...
      return (
        t.queryHash || (t.queryHash = Tr(t.queryKey, t)),
  ...
  Sf = C.createContext(void 0),
  Rf = ({ client: e, children: t }) => (
    C.useEffect(
      () => (
        e.mount(),
        () => {
    ...
    w.jsx(Sf.Provider, { value: e, children: t })
  );
const Pf = "/assets/styles-GdAqoNh3.css";
function _f(e, t = {}) {
  typeof window > "u" ||
  ...
  (
    ...
    C.createElement(
      "svg",
      {
        ...
        className: po("lucide", s),
        ...(!o && !Lf(c) && { "aria-hidden": "true" }),
        ...c,
      },
      [...i.map(([l, f]) => C.createElement(l, f)), ...(Array.isArray(o) ? o : [o])],
    ),
);
const ze = (e, t) => {
  const r = C.forwardRef(({ className: n, ...s }, o) =>
    C.createElement(Mf, {
      ref: o,
      iconNode: t,
      className: po(`lucide-${Cf(Bn(e))}`, `lucide-${e}`, n),
      ...s,
    }),
  );
...
function Hf() {
      ...
      (c(!0),
        setTimeout(() => {
          ...
          (g
            ...
            : h.toLowerCase().includes("taxa") || h.toLowerCase().includes("juros")
              ? (v =
              ...
              : (h.toLowerCase().includes("prazo") || h.toLowerCase().includes("tempo")) &&
                (v =
                  "A liberação dos recursos ocorre em até 48 horas após a assinatura do contrato. É bem rápido!"),
            n((m) => [...m, { id: Date.now().toString(), text: v, sender: "bot" }]),
            c(!1));
        }, 1500));
    },
    u = (h) => {
      if ((h?.preventDefault(), !s.trim())) return;
      const g = s.trim();
      (n((v) => [...v, { id: Date.now().toString(), text: g, sender: "user" }]), o(""), f(g));
    },
    p = (h) => {
  ...
  return w.jsxs(w.Fragment, {
    children: [
      w.jsxs("button", {
        onClick: () => t(!e),
        className: `fixed bottom-6 right-6 z-50 flex size-14 items-center justify-center rounded-full bg-[#3674EF] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:bg-[#2f63d6] ${e ? "scale-0 opacity-0" : "scale-100 opacity-100"}`,
        "aria-label": "Abrir chat",
        children: [
          w.jsx(kf, { className: "size-6" }),
          w.jsx("span", {
            className:
              "absolute right-3 top-3 size-2.5 animate-pulse rounded-full bg-[#4EB7FF] ring-2 ring-[#3674EF]",
          }),
        ],
      }),
      w.jsxs("div", {
        className: `fixed bottom-6 right-6 z-50 flex w-[calc(100vw-3rem)] max-w-[380px] flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#060d1f] shadow-2xl transition-all duration-300 sm:w-[380px] origin-bottom-right ${e ? "scale-100 opacity-100" : "scale-50 opacity-0 pointer-events-none"}`,
        children: [
          w.jsxs("div", {
            className:
              "flex items-center justify-between border-b border-white/10 bg-[#081127] p-4",
            children: [
              w.jsxs("div", {
                ...
                children: [
                  w.jsx("div", {
                    className:
                      "flex size-8 items-center justify-center rounded-full bg-[#3674EF]/20 text-[#4EB7FF]",
                    children: w.jsx(Af, { className: "size-5" }),
                  }),
                  w.jsxs("div", {
                    children: [
                      w.jsx("h3", {
                        className: "font-display text-sm font-semibold text-white",
                        children: "Assistente Ótmow",
                      }),
                      w.jsxs("p", {
                        className: "flex items-center gap-1.5 text-xs text-[#4EB7FF]",
                        children: [
                          w.jsx("span", { className: "size-1.5 rounded-full bg-[#4EB7FF]" }),
                          " Online",
                        ],
                      }),
                    ],
              ...
              w.jsx("button", {
                onClick: () => t(!1),
                className:
                  "rounded-full p-1.5 text-slate-400 transition-colors hover:bg-white/5 hover:text-white",
                children: w.jsx($f, { className: "size-5" }),
              }),
            ],
          }),
          w.jsxs("div", {
            className:
              "flex h-[400px] flex-col gap-4 overflow-y-auto p-4 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10",
            children: [
              r.map((h) =>
                w.jsx(
                  "div",
                  {
                    className: `flex w-full ${h.sender === "user" ? "justify-end" : "justify-start"}`,
                    children: w.jsx("div", {
                      className: `relative max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${h.sender === "user" ? "rounded-br-sm bg-[#3674EF] text-white" : "rounded-bl-sm border border-white/10 bg-white/5 text-slate-200"}`,
                      children: h.file
                        ? w.jsxs("div", {
                            className: "flex items-center gap-2",
                            children: [
                              w.jsx(jf, { className: "size-4 opacity-80" }),
                              w.jsx("span", {
                                className:
                                  "font-medium underline decoration-white/30 underline-offset-2",
                                children: h.text,
                              }),
                            ],
                          })
              ...
              i &&
                w.jsx("div", {
                  ...
                  children: w.jsxs("div", {
                    className:
                      "flex max-w-[85%] items-center gap-1.5 rounded-2xl rounded-bl-sm border border-white/10 bg-white/5 px-4 py-3.5",
                    children: [
                      w.jsx("span", {
                        className: "size-1.5 animate-bounce rounded-full bg-[#4EB7FF]",
                      }),
                      w.jsx("span", {
                        className:
                          "size-1.5 animate-bounce rounded-full bg-[#4EB7FF] [animation-delay:0.2s]",
                      }),
                      w.jsx("span", {
                        className:
                          "size-1.5 animate-bounce rounded-full bg-[#4EB7FF] [animation-delay:0.4s]",
                      }),
                    ],
                  }),
                }),
          ...
          w.jsxs("div", {
            className: "border-t border-white/10 bg-[#081127] p-3",
            children: [
              w.jsxs("form", {
                onSubmit: u,
                className:
                  "flex items-center gap-2 rounded-full border border-white/10 bg-[#060d1f] p-1 pr-2 transition-colors focus-within:border-[#4EB7FF]/50",
                children: [
                  w.jsxs("label", {
                    className:
                      "flex size-9 cursor-pointer items-center justify-center rounded-full text-slate-400 transition-colors hover:bg-white/5 hover:text-[#4EB7FF]",
                    children: [
                      w.jsx(Df, { className: "size-4" }),
                      w.jsx("input", {
                        type: "file",
                        className: "hidden",
                        ref: l,
                  ...
                  w.jsx("input", {
                    ...
                    className:
                      "flex-1 bg-transparent px-2 text-sm text-white placeholder-slate-500 outline-none",
                  }),
                  w.jsx("button", {
                    type: "submit",
                    disabled: !s.trim(),
                    className:
                      "flex size-9 items-center justify-center rounded-full bg-[#3674EF] text-white transition-transform hover:scale-105 disabled:opacity-50 disabled:hover:scale-100",
                    children: w.jsx(Uf, { className: "size-4 -translate-x-px translate-y-px" }),
                  }),
                ],
              }),
              w.jsx("div", {
                className: "mt-2 text-center text-[10px] text-slate-500",
                children: "Respostas geradas automaticamente para simulação.",
              }),
            ],
          }),
        ],
...
function Wf({ error: e, reset: t }) {
  console.error(e);
  const r = z();
  return (
    C.useEffect(() => {
      _f(e, { boundary: "tanstack_root_error_component" });
    }, [e]),
    w.jsx("div", {
      className: "flex min-h-screen items-center justify-center bg-background px-4",
      children: w.jsxs("div", {
...
function Kf({ children: e }) {
  return w.jsxs("html", {
    lang: "pt-BR",
    children: [
      w.jsx("head", { children: w.jsx(zl, {}) }),
      w.jsxs("body", { children: [e, w.jsx($l, {})] }),
    ],
  });
}
function Qf() {
  const { queryClient: e } = me.useRouteContext();
  return w.jsxs(Rf, { client: e, children: [w.jsx(no, {}), w.jsx(Hf, {})] });
}
const Gf = "modulepreload",
  Yf = function (e) {
    return "/" + e;
  },
  Un = {},
  ...
  Jf = () => $e(() => import("./sobre-7dI86hRK.js"), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6])),
  Xf = Be("/sobre")({ component: Ue(Jf, "component") }),
  Zf = () => $e(() => import("./parceiros-pC3_ubjC.js"), __vite__mapDeps([7, 1, 2, 3, 8, 9])),
  ed = Be("/parceiros")({ component: Ue(Zf, "component") }),
  td = () => $e(() => import("./gestores-BWMomBnK.js"), __vite__mapDeps([10, 1, 2, 4, 8])),
  rd = Be("/gestores")({ component: Ue(td, "component") }),
  nd = () => $e(() => import("./faq-BbILqH_J.js"), __vite__mapDeps([11, 1, 2, 3, 12])),
  sd = Be("/faq")({ component: Ue(nd, "component") }),
  od = () =>
    $e(() => import("./clientes-DmzIpULA.js"), __vite__mapDeps([13, 1, 2, 14, 3, 5, 9, 8])),
  id = Be("/clientes")({ component: Ue(od, "component") }),
  ad = () =>
    $e(() => import("./index-D3XUc_xl.js"), __vite__mapDeps([15, 1, 2, 14, 12, 3, 4, 5, 8, 6, 9])),
  cd = Be("/")({ component: Ue(ad, "component") }),
  ud = Xf.update({ id: "/sobre", path: "/sobre", getParentRoute: () => me }),
  ld = ed.update({ id: "/parceiros", path: "/parceiros", getParentRoute: () => me }),
  fd = rd.update({ id: "/gestores", path: "/gestores", getParentRoute: () => me }),
  dd = sd.update({ id: "/faq", path: "/faq", getParentRoute: () => me }),
  hd = id.update({ id: "/clientes", path: "/clientes", getParentRoute: () => me }),
  pd = cd.update({ id: "/", path: "/", getParentRoute: () => me }),
  md = {
    IndexRoute: pd,
    ClientesRoute: hd,
    FaqRoute: dd,
...
async function vd() {
  ...
  return (
    ...
    e.stores.matchesId.get().length || (await $u(e)),
    e
  );
}
var bd = vd;
...
var ir;
function xd() {
  return (ir || (ir = wd()), w.jsx(Wu, { promise: ir, children: (e) => w.jsx(Dl, { router: e }) }));
}
C.startTransition(() => {
  wo.hydrateRoot(document, w.jsx(C.StrictMode, { children: w.jsx(xd, {}) }));
});
export { jf as F, Mr as L, kf as M, $f as X, $e as _, ze as c };
